...
<head>
    ...
    <title>Maintenance & Parts Analytics | FarmPro</title>
...
<div class="container">
    ...
    <header class="page-header">
        <div class="header-info">
            <h1>Maintenance & Parts <span>Analytics</span></h1>
            <p>Spare parts inventory, repair cost trends, and physical stock levels.</p>
        </div>
        <a href="maintenance_report.php" class="btn-view"><i class="fa-solid fa-file-invoice"></i> View Detailed Report</a>
    </header>
    ...
    <div class="kpi-grid">
        <div class="kpi-card stat-amber">
            ...
            <div class="kpi-value">₱<?= number_format($kpi['total_inventory_value'] / 1000, 1) ?>k</div>
            <div class="kpi-sub">Total Assets Valuation</div>
        </div>

        <div class="kpi-card stat-slate">
            <div class="kpi-header">
                <div class="kpi-title">Distinct Parts</div>
                <div class="kpi-icon"><i class="fa-solid fa-gears"></i></div>
            </div>
            <div class="kpi-value" style="color: #cbd5e1;"><?= number_format($kpi['distinct_parts']) ?></div>
        ...
        <div class="kpi-card stat-emerald">
            <div class="kpi-header">
                <div class="kpi-title">Avg. Cost / Part</div>
    ...
    <div class="charts-container">
        <div class="chart-box">
            <div class="chart-title"><i class="fa-solid fa-chart-line" style="color:var(--amber);"></i> Cost Trend (Last 12 Months)</div>
        ...
        <div class="chart-box">
            <div class="chart-title"><i class="fa-solid fa-chart-pie" style="color:var(--slate);"></i> Value Distribution by Part</div>
            <div class="chart-canvas-wrapper">
        ...
        <div class="chart-box full-width">
            <div class="chart-title"><i class="fa-solid fa-list-ol" style="color:var(--blue);"></i> Top 5 Parts by Quantity</div>
    ...
    new Chart(document.getElementById('distChart'), {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: ['#f59e0b', '#d97706', '#b45309', '#64748b', '#475569'], // Amber & Slate mix
                borderWidth: 0,
                hoverOffset: 6
            }]
        },
