...
checkAccess('farm_equipment_tools_report');
...
try {
    ...
    // --- 2. BUILD SQL QUERY ---
    // Fetch items where ITEM_TYPE_ID = 4 (Farm Equipment & Tools)
    $sql = "SELECT 
            i.ITEM_ID,
            i.ITEM_NAME,
            i.ITEM_DESCRIPTION,
...
<head>
    ...
    <title>Equipment Purchase Report</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .stat-card.purple::before { background: linear-gradient(135deg, rgba(139,92,246,0.04), transparent); }
        ...
        .filter-badge {
            ...
            background: var(--purple); color: #fff; border-radius: 99px; padding: 0 6px;
        }
        .filter-toggle-btn {
        ...
        .form-label.accent { color: var(--purple); }
        ...
        .form-control:focus {
            border-color: var(--border-active); box-shadow: 0 0 0 3px var(--purple-glow);
        ...
        .btn-primary:hover { background: #7c3aed; box-shadow: 0 0 16px var(--purple-glow); color: #fff; }
        ...
        .val-count { font-family: var(--font-mono); color: var(--purple); font-size: 0.85rem; font-weight: 600; }
...
<div class="container">
    ...
    <div class="top-bar">
        ...
        <span class="page-badge"><i class="fa-solid fa-tractor"></i> Tools & Equipment</span>
    </div>

    <div class="page-header">
        <h1 class="page-title">Equipment <span>Purchase</span> Report</h1>
        <p class="page-subtitle">Log of purchased tools, machinery, and equipment.</p>
    </div>
    ...
    <div class="stats-grid">
        <div class="stat-card purple">
            <div class="stat-icon purple"><i class="fa-solid fa-boxes-packing"></i></div>
            <div class="stat-val purple"><?= number_format($unique_items_count) ?></div>
            <div class="stat-lbl">Unique Items Purchased</div>
        </div>
        <div class="stat-card blue">
            ...
            <div class="stat-lbl">Total Units Acquired</div>
        </div>
    ...
    <div class="filter-panel">
            ...
            <form method="GET" id="filterForm">
                <div class="filter-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="search" class="form-control" placeholder="e.g. Shovel, Pump" value="<?= htmlspecialchars($search_term) ?>">
                    </div>
        ...
        <div class="filter-footer">
            <div class="filter-footer-left">
                <a href="equipment_report.php" class="btn btn-ghost btn-sm">
                        ...
                        <tr>
                            <td colspan="7">
                                <div class="empty-state">
                                    ...
                                    <p>No equipment purchase records found matching your filters.</p>
                                </div>
                            </td>
                        </tr>
                    <?php else: ?>
...
<script>
    ...
    function exportPDF() {
        ...
        doc.setFontSize(16); doc.setTextColor(139, 92, 246); // Purple
        doc.text("Equipment Purchase Report", 14, 14);
        ...
        doc.save('Equipment_Purchase_Report.pdf');
    }
    ...
    function exportCSV() {
        ...
        link.setAttribute("download", "Equipment_Report_" + new Date().toISOString().slice(0,10) + ".csv");
