...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        th { 
            background: rgba(15, 23, 42, 0.9); color: #a78bfa; 
...
<div class="container">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-val text-green"><?= number_format($total_units) ?></div>
        </div>
        <div class="stat-card">
            <div class="stat-lbl">Total Purchase Value</div>
            <div class="stat-val text-purple">₱<?= number_format($total_value, 2) ?></div>
        </div>
    </div>
        ...
        <form method="GET">
            <div class="filter-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="search" class="form-input" placeholder="e.g. Shovel, Pump" value="<?= htmlspecialchars($search_term) ?>">
                </div>
                
                <div class="btn-group">
                    <button type="submit" class="btn btn-primary">Apply Filters</button>
                    <a href="equipment_report.php" class="btn btn-outline">Reset</a>
                </div>
            </div>
    ...
    <div class="table-wrap">
        <table>
            ...
            <tbody>
                <?php if(empty($items)): ?>
                    <tr><td colspan="7" style="text-align:center; padding:3rem; color:#64748b;">No purchase records found.</td></tr>
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td data-label="Quantity" style="text-align:right; font-weight:bold; color:#a78bfa;">
                            <?= number_format($i['QUANTITY']) ?>
                        </td>
                        <td data-label="Unit Cost" style="text-align:right;">₱<?= number_format($i['UNIT_COST'], 2) ?></td>
                        <td data-label="Total Cost" style="text-align:right; color:#4ade80;">₱<?= number_format($i['CALCULATED_TOTAL'], 2) ?></td>
                    </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
...
<script>
    ...
    function exportPDF() {
        ...
        doc.text("Equipment Purchase Report", 14, 15);
        ...
        doc.autoTable({
            ...
            startY: 30,
            styles: { fontSize: 8 },
            headStyles: { fillColor: [139, 92, 246] } // Violet Header
        });
