...
try {
    ...
    // We group by TRANSACTION_DATE to identify batches
    $sql = "SELECT 
                tt.TRANSACTION_DATE,
                MAX(tt.ADMINISTERED_BY) as ADMINISTERED_BY,
                COUNT(tt.TT_ID) as record_count,
                GROUP_CONCAT(DISTINCT m.SUPPLY_NAME SEPARATOR ', ') as medicines_used,
...
<head>
    ...
    <title>Reverse Medication | FarmPro</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-select:focus { border-color: var(--purple); box-shadow: 0 0 0 3px rgba(168,85,247,0.15); background: var(--bg-hover); }
        ...
        .info-val.highlight { color: var(--purple); }
...
<div class="container">
    ...
    <div class="page-header">
        <h1 class="page-title"><i class="fa-solid fa-clock-rotate-left" style="color:var(--red);"></i> Admin <span>Undo</span> Medication</h1>
        <p class="page-desc">Select a historical medication batch to permanently delete its records and restore inventory.</p>
    </div>
        ...
        <div class="main-grid">
            ...
            <div class="control-panel">
                ...
                <div class="form-group">
                    ...
                    <select id="batchSelect" class="form-select" onchange="handleBatchSelection()">
                        ...
                        <?php foreach($batches as $b): ?>
                            <option value="<?= htmlspecialchars($b['TRANSACTION_DATE']) ?>">
                                <?= date('M d, Y - h:i A', strtotime($b['TRANSACTION_DATE'])) ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div class="alert-box">
                    ...
                    <div>
                        <strong>Warning:</strong> This action is permanent. Reversing a batch will completely delete its transaction records and re-add the used quantities back into your medical inventory.
                    </div>
                </div>
            </div>
            ...
            <div id="detailsPanel" class="details-panel">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-row">
                        <span class="info-lbl">Medicines Used</span>
                        <span class="info-val highlight" id="lbl_meds" style="font-family: var(--font); font-size: 0.95rem;">—</span>
                    </div>
                    <div class="info-row">
                    ...
                    <div class="info-row">
                        <span class="info-lbl">Total Base Cost</span>
...
<script>
    ...
    function handleBatchSelection() {
        ...
        const batch = batchData.find(b => String(b.TRANSACTION_DATE) === String(selectedDate));
        ...
        if (batch) {
            ...
            document.getElementById('lbl_meds').textContent = batch.medicines_used || 'Unknown';
            document.getElementById('lbl_person').textContent = batch.ADMINISTERED_BY || 'Unknown';
    ...
    function confirmReversal() {
        ...
        if(!confirm(`DANGER: Are you absolutely sure you want to delete this medication batch?\n\nThis will permanently remove the transactions from the ledger and restore the medicine stock.`)) {
            return;
        }
