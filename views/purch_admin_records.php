<?php
// views/purch_administration_records.php
error_reporting(0);
            ...
            <table class="table">
                ...
                <tbody id="item-table">
                    ...
                    <tr data-item-id="<?php echo $item['ITEM_ID']; ?>"
                        ...
                        <td>
                            <div class="item-id">ADM-<?php echo str_pad($item['ITEM_ID'], 4, '0', STR_PAD_LEFT); ?></div>
                        </td>
                        <td>
    ...
    <div id="confirm-all-modal" class="modal">
        <div class="modal-content" style="max-width: 450px;">
            <div class="modal-body confirm-content">
                ...
                <p style="color: #64748b;">This will confirm and lock <strong>ALL</strong> currently pending administration & records purchases.</p>
                <div class="warning-text">
