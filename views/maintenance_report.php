    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .title { 
            ...
            font-weight: 800; 
            background: linear-gradient(135deg, #d97706, #92400e); /* Bronze/Rust */
        ...
        .btn-primary { background: #92400e; color: white; }
        ...
        th { 
            background: rgba(15, 23, 42, 0.9); color: #d97706; 
...
<div class="container">
    ...
    <div class="header">
        <h1 class="title">Maintenance & Parts Report</h1>
        <p class="subtitle">Log of repair parts, hardware, and maintenance supplies.</p>
    </div>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-val text-bronze"><?= number_format($total_units) ?></div>
        </div>
        <div class="stat-card">
            <div class="stat-lbl">Total Expense</div>
            <div class="stat-val text-orange">₱<?= number_format($total_value, 2) ?></div>
        </div>
    </div>
        ...
        <form method="GET">
            <div class="filter-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="search" class="form-input" placeholder="e.g. Nails, Oil, Bulb" value="<?= htmlspecialchars($search_term) ?>">
                </div>
                
                <div class="btn-group">
                    <button type="submit" class="btn btn-primary">Apply Filters</button>
                    <a href="maintenance_report.php" class="btn btn-outline">Reset</a>
                </div>
            </div>
    ...
    <div class="table-wrap">
        <table>
            ...
            <tbody>
                <?php if(empty($items)): ?>
                    <tr><td colspan="7" style="text-align:center; padding:3rem; color:#64748b;">No maintenance records found.</td></tr>
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td data-label="Quantity" style="text-align:right; font-weight:bold; color:#d97706;">
                            <?= number_format($i['QUANTITY']) ?>
                        </td>
                        <td data-label="Unit Cost" style="text-align:right;">₱<?= number_format($i['UNIT_COST'], 2) ?></td>
                        <td data-label="Total Cost" style="text-align:right; color:#f97316;">₱<?= number_format($i['CALCULATED_TOTAL'], 2) ?></td>
                    </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
...
<script>
    ...
    function exportPDF() {
        ...
        doc.text("Maintenance & Parts Report", 14, 15);
        ...
        doc.autoTable({
            ...
            startY: 30,
            styles: { fontSize: 8 },
            headStyles: { fillColor: [146, 64, 14] } // Rust Header
        });
