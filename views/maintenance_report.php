<?php
// reports/maintenance_report.php
error_reporting(0);
...
checkAccess('maintenance_parts_report');
...
try {
    ...
    // --- 2. BUILD SQL QUERY ---
    // Fetch items where ITEM_TYPE_ID = 8 (Maintenance & Parts)
    $sql = "SELECT 
            i.ITEM_ID,
            i.ITEM_NAME,
            i.ITEM_DESCRIPTION,
...
<head>
    ...
    <title>Maintenance & Parts Report</title>
    ...
    <style>
        ...
        :root {
            ...
            --border-active:  rgba(217,119,6,0.5); /* Bronze Accent */
            --bronze:         #d97706;
            --bronze-dim:     rgba(217,119,6,0.12);
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body {
            ...
            background-image:
                ...
                radial-gradient(ellipse 40% 30% at 85% 10%, rgba(249,115,22,0.04) 0%, transparent 50%);
        }
        ...
        .page-badge {
            ...
            color: var(--bronze); background: var(--bronze-dim); border: 1px solid rgba(217,119,6,0.2);
        ...
        .page-title span {
            background: linear-gradient(135deg, var(--bronze), var(--rust));
        ...
        .stat-card.bronze::before { background: linear-gradient(135deg, rgba(217,119,6,0.04), transparent); }
        .stat-card.orange::before { background: linear-gradient(135deg, rgba(249,115,22,0.04), transparent); }
        .stat-card.green::before  { background: linear-gradient(135deg, rgba(34,197,94,0.04), transparent); }

        .stat-card.bronze { border-color: rgba(217,119,6,0.15); }
        ...
        .stat-icon.bronze { background: var(--bronze-dim); color: var(--bronze); }
        ...
        .stat-val.bronze { color: var(--bronze); }
        ...
        .filter-badge {
            ...
            background: var(--bronze); color: #000; border-radius: 99px; padding: 0 6px;
        }
        .filter-toggle-btn {
        ...
        .form-label.accent { color: var(--bronze); }
        ...
        .form-control:focus {
            border-color: var(--border-active); box-shadow: 0 0 0 3px var(--bronze-glow);
        ...
        .btn-primary:hover { background: var(--bronze); box-shadow: 0 0 16px var(--bronze-glow); color: #000; }
        ...
        .val-count { font-family: var(--font-mono); color: var(--orange); font-size: 0.85rem; font-weight: 600; }
...
<div class="container">
    ...
    <div class="top-bar">
        ...
        <span class="page-badge"><i class="fa-solid fa-screwdriver-wrench"></i> Maintenance & Parts</span>
    </div>

    <div class="page-header">
        <h1 class="page-title">Maintenance <span>& Parts</span> Report</h1>
        <p class="page-subtitle">Log of repair parts, hardware, and maintenance supplies.</p>
    </div>

    <div class="stats-grid">
        <div class="stat-card bronze">
            <div class="stat-icon bronze"><i class="fa-solid fa-toolbox"></i></div>
            <div class="stat-val bronze"><?= number_format($unique_items_count) ?></div>
            <div class="stat-lbl">Unique Parts</div>
        </div>
        <div class="stat-card orange">
            <div class="stat-icon orange"><i class="fa-solid fa-boxes-stacked"></i></div>
            <div class="stat-val orange"><?= number_format($total_units) ?></div>
    ...
    <div class="filter-panel">
            ...
            <form method="GET" id="filterForm">
                <div class="filter-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="search" class="form-control" placeholder="e.g. Nails, Oil, Bulb" value="<?= htmlspecialchars($search_term) ?>">
                    </div>
        ...
        <div class="filter-footer">
            <div class="filter-footer-left">
                <a href="maintenance_report.php" class="btn btn-ghost btn-sm">
                        ...
                        <tr>
                            <td colspan="7">
                                <div class="empty-state">
                                    ...
                                    <p>No maintenance or parts records found matching your filters.</p>
                                </div>
                            </td>
                        </tr>
                    <?php else: ?>
...
<script>
    ...
    function exportPDF() {
        ...
        doc.setFontSize(16); doc.setTextColor(146, 64, 14); // Rust
        doc.text("Maintenance & Parts Report", 14, 14);
        ...
        doc.autoTable({
            ...
            headStyles: { fillColor: [180, 83, 9] } // Bronze Header
        });

        doc.save('Maintenance_Parts_Report.pdf');
    }
    ...
    function exportExcel() {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "Parts & Supplies");
