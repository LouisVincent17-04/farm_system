...
<head>
    ...
    <title>Feeds Usage & Accountancy | FarmPro</title>
...
<div class="container">
    ...
    <div class="page-header">
        <div class="header-info">
            <h1 class="page-title">Feeds Usage <span>&amp; Ledger</span></h1>
            <p class="page-subtitle">Financial and physical overview of feed purchases, consumption, adjustments, and live balances.</p>
        </div>
    </div>
    ...
    <div class="acc-summary-grid">
        <div class="acc-card c-inwards">
            ...
            <div class="acc-val"><?= number_format($purchased_qty, 2) ?> <span style="font-size:1rem;color:var(--text-muted);">kg</span></div>
        ...
        <div class="acc-card c-outwards">
            <div class="acc-header">
                ...
                <div class="acc-title">Total Consumed (OUT)</div>
            </div>
            <div class="acc-val"><?= number_format($grand_total_kg, 2) ?> <span style="font-size:1rem;color:var(--text-muted);">kg</span></div>
        ...
        <div class="acc-card c-variance">
            ...
            ?>
            <div class="acc-val"><?= number_format($var_qty, 2) ?> <span style="font-size:1rem;color:var(--text-muted);">kg</span></div>
        ...
        <div class="acc-card c-adjust">
            ...
            ?>
            <div class="acc-val" style="color:<?= $adj_color ?>;"><?= $adj_sign . number_format($net_adjustments, 2) ?> <span style="font-size:1rem;color:var(--text-muted);">kg</span></div>
        ...
        <div class="acc-card c-adj-net">
            ...
            <div class="acc-val"><?= number_format($expected_net, 2) ?> <span style="font-size:1rem;color:var(--text-muted);">kg</span></div>
        ...
        <div class="acc-card c-stock">
            ...
            <div class="acc-val"><?= number_format($current_stock, 2) ?> <span style="font-size:1rem;color:var(--text-muted);">kg</span></div>
    ...
    <div class="filter-panel">
        ...
        <div class="filter-footer">
            <div class="filter-footer-left">
                <a href="feeds_usage_report.php" class="btn btn-ghost btn-sm">
    ...
    <?php else: ?>
                        ...
                        <tbody>
                            <?php foreach ($group['items'] as $item): ?>
                                <tr>
                                    ...
                                    <td data-label="Used KGs (OUT)" class="t-right val-mono" style="color:var(--blue);">
                                        <?= number_format($item['TOTAL_KGS'], 2) ?> kg
                                    </td>
                        ...
                        <tbody>
                            <?php foreach ($adjustments_data as $adj): ?>
                                <tr>
                                    ...
                                    <td data-label="Feed Name" class="col-name"><?= htmlspecialchars($adj['ITEM_NAME']) ?></td>
                                    <td data-label="Type">
                        ...
                        <tbody>
                            <?php foreach ($purchases_by_feed as $fName => $pData): ?>
                                ...
                                <tr>
                                    ...
                                    <td data-label="Used KGs (OUT)" class="t-right val-mono" style="color:var(--text-muted);">0.00 kg</td>
        ...
        <div class="group-container" style="border-color: var(--blue);">
            <div class="group-header" style="background: rgba(59, 130, 246, 0.15); color: #fff;">
                <i class="fa-solid fa-chart-pie"></i> GRAND TOTAL (Filtered Outwards)
            </div>
            <div class="table-wrap">
                <table class="table">
                    <tbody>
                        <tr class="row-total" style="font-size: 1rem;">
                            <td data-label="Summary" style="color: var(--blue);">OVERALL USAGE</td>
                            <td data-label="Used KGs (OUT)" class="t-right val-mono" style="color: var(--blue);"><?= number_format($grand_total_kg, 2) ?> kg</td>
