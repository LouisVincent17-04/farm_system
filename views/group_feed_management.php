...
<head>
    ...
    <title>Group Feed Management | FarmPro</title>
...
<body>
    ...
    <div class="container">
        ...
        <header class="page-header">
            <h1 class="page-title">Group Feed <span>Management</span></h1>
            <p class="page-subtitle">Track bulk feeding transactions and monitor inventory.</p>
            <p class="page-description">Manage all aspects of mass livestock feeding and central feed stock levels.</p>
        </header>
        ...
        <div class="management-grid">
            ...
            <a href="group_feed_transaction.php" class="management-card c-add">
                <div class="card-icon blue"><i class="fa-solid fa-pen-to-square"></i></div>
                <h3 class="card-title">Add Group Feeding</h3>
                <p class="card-description">Record new bulk feeding activities, track total consumption, and maintain detailed feeding logs for entire pens.</p>
                
                <ul class="card-features">
                    <li><i class="fa-solid fa-check"></i> Record bulk feed distribution per pen.</li>
                    <li><i class="fa-solid fa-check"></i> Track animal group consumption rates.</li>
                    <li><i class="fa-solid fa-check"></i> Add operational notes and dietary comments.</li>
                </ul>
