    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .title { 
            ...
            font-weight: 800; 
            background: linear-gradient(135deg, #94a3b8, #64748b); /* Slate/Gray */
...
<div class="container">
    ...
    <div class="header">
        <h1 class="title">Admin & Records Report</h1>
        <p class="subtitle">Log of office supplies, logbooks, and administrative materials.</p>
    </div>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-val text-slate"><?= number_format($total_units) ?></div>
        </div>
        <div class="stat-card">
            <div class="stat-lbl">Total Expense</div>
            <div class="stat-val text-gray">₱<?= number_format($total_value, 2) ?></div>
        </div>
    </div>
        ...
        <form method="GET">
            <div class="filter-grid">
                ...
                <div class="form-group">
                    ...
                    <select name="location" class="form-input" <?php echo ($USER_LOCATION_ != 1000) ? 'style="pointer-events: none; opacity: 0.7; background-color: #1e293b;"' : ''; ?>>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="search" class="form-input" placeholder="e.g. Logbook, Bond Paper" value="<?= htmlspecialchars($search_term) ?>">
                </div>
                
                <div class="btn-group">
                    <button type="submit" class="btn btn-primary">Apply Filters</button>
                    <a href="admin_records_report.php" class="btn btn-outline">Reset</a>
                </div>
            </div>
    ...
    <div class="table-wrap">
        <table>
            ...
            <tbody>
                <?php if(empty($items)): ?>
                    <tr><td colspan="7" style="text-align:center; padding:3rem; color:#64748b;">No admin supply records found.</td></tr>
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td data-label="Quantity" style="text-align:right; font-weight:bold; color:#cbd5e1;">
                            <?= number_format($i['QUANTITY']) ?>
                        </td>
                        <td data-label="Unit Cost" style="text-align:right;">₱<?= number_format($i['UNIT_COST'], 2) ?></td>
                        <td data-label="Total Cost" style="text-align:right; color:#9ca3af;">₱<?= number_format($i['CALCULATED_TOTAL'], 2) ?></td>
                    </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
...
<script>
    ...
    function exportPDF() {
        ...
        doc.text("Admin & Records Supplies Report", 14, 15);
