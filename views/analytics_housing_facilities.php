...
checkAccess('housing_facilities_analytics');
...
<head>
    ...
    <title>Housing Analytics | FarmPro</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .page-badge {
            ...
            color: var(--slate); background: var(--slate-dim); border: 1px solid rgba(148,163,184,0.2);
        ...
        .header-info h1 span { background: linear-gradient(135deg, var(--slate), #475569); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
        ...
        .btn-view:hover { background: var(--slate-dim); border-color: var(--slate); color: #fff; transform: translateY(-2px);}
        ...
        .stat-slate .kpi-value { color: var(--slate); }
...
<div class="container">
    ...
    <header class="page-header">
        <div class="header-info">
            <h1>Housing & Facilities <span>Analytics</span></h1>
            <p>Asset valuation, facility counts, and physical infrastructure trends.</p>
        </div>
        <a href="housing_report.php" class="btn-view"><i class="fa-solid fa-file-invoice"></i> View Detailed Report</a>
    </header>
    ...
    <div class="kpi-grid">
        <div class="kpi-card stat-slate">
            <div class="kpi-header">
                ...
                <div class="kpi-icon"><i class="fa-solid fa-building-shield"></i></div>
            </div>
            <div class="kpi-value" style="color: #fff;">₱<?= number_format($kpi['total_asset_value'] / 1000, 1) ?>k</div>
            <div class="kpi-sub">Investment in Housing</div>
        </div>

        <div class="kpi-card stat-emerald">
            <div class="kpi-header">
                <div class="kpi-title">Facility Types</div>
                <div class="kpi-icon"><i class="fa-solid fa-warehouse"></i></div>
            </div>
            <div class="kpi-value"><?= number_format($kpi['total_items']) ?></div>
            <div class="kpi-sub">Distinct Item Categories</div>
        </div>
    ...
    <div class="charts-container">
        <div class="chart-box">
            <div class="chart-title"><i class="fa-solid fa-chart-line" style="color:var(--slate);"></i> Investment Trend (Last 12 Months)</div>
        ...
        <div class="chart-box">
            <div class="chart-title"><i class="fa-solid fa-chart-pie" style="color:var(--emerald);"></i> Asset Value Distribution</div>
            <div class="chart-canvas-wrapper">
        ...
        <div class="chart-box full-width">
            <div class="chart-title"><i class="fa-solid fa-list-ol" style="color:var(--blue);"></i> Top 5 Facilities by Physical Quantity</div>
    ...
    new Chart(document.getElementById('distChart'), {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: ['#64748b', '#94a3b8', '#cbd5e1', '#475569', '#334155'], // Slate palette
                borderWidth: 0,
                hoverOffset: 6
            }]
        },
