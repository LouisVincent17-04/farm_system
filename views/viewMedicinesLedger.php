<?php
// reports/viewMedicineLedger.php
error_reporting(0);
...
<head>
    ...
    <title>Medicine Ledger - <?= htmlspecialchars($medicine['SUPPLY_NAME'] ?? 'Error') ?></title>
    ...
    <style>
        ...
        .supply-title { font-size: 2.2rem; font-weight: 800; color: #f472b6; margin: 0 0 5px 0; display: flex; align-items: center; flex-wrap: wrap; gap: 10px; }
        ...
        .type-usage { background: rgba(219, 39, 119, 0.15); color: #f472b6; border: 1px solid rgba(219, 39, 119, 0.3); }
    ...
    <?php else: ?>
        ...
        <div class="supply-header-wrapper">
            <h1 class="supply-title">
                <?= htmlspecialchars($medicine['SUPPLY_NAME']) ?>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card" style="border-top: 4px solid #22c55e; background: rgba(34, 197, 94, 0.05);">
                ...
                <div class="stat-val c-stock"><?= number_format($medicine['TOTAL_STOCK'], 2) ?> <span style="font-size: 1rem; color:#94a3b8;"><?= htmlspecialchars($unit_label) ?></span></div>
            </div>
        </div>
        ...
        <div class="table-wrap">
            <table>
                ...
                <tbody>
                    <?php if(empty($ledger)): ?>
                        <tr><td colspan="4" class="empty-state">No transaction history found for this medicine.</td></tr>
                    <?php else: ?>
                        <?php foreach($ledger as $row): 
                            ...
                            $badgeClass = 'type-add';
                            if ($row['txn_type'] == 'Medical Treatment') $badgeClass = 'type-usage';
