...
<head>
    ...
    <title>Vaccine Ledger | <?= htmlspecialchars($vaccine['SUPPLY_NAME'] ?? 'Details') ?></title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        body {
            ...
            background-image: radial-gradient(ellipse 80% 50% at 50% -20%, rgba(45,212,191,0.05) 0%, transparent 60%);
        }
        ...
        .supply-title span.text-teal { background: linear-gradient(135deg, var(--teal), #0d9488); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
        ...
        .type-usage { background: var(--blue-dim); color: var(--blue); border: 1px solid rgba(59,130,246,0.3); } /* Blue for Vaccines Usage */
...
<div class="container">
    ...
    <?php if(isset($error)): ?>
        <div class="error-box">
            ...
            <p style="color: var(--text-muted); margin-top: 0.5rem;">The requested vaccine profile could not be loaded.</p>
        </div>
    <?php else: ?>

        <div class="supply-header-wrapper">
            <h1 class="supply-title">
                <span class="text-teal"><?= htmlspecialchars($vaccine['SUPPLY_NAME']) ?></span>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card stat-emerald" style="background: rgba(16,185,129,0.05);">
                ...
                <div class="stat-val c-stock"><?= number_format($vaccine['TOTAL_STOCK'], 2) ?> <span><?= htmlspecialchars($unit_label) ?></span></div>
            </div>
        </div>
                        ...
                        <?php if(empty($ledger)): ?>
                            <tr>
                                <td colspan="4" class="empty-state">
                                    ...
                                    No transaction history found for this vaccine.
                                </td>
                            </tr>
                        <?php else: ?>
                            <?php foreach($ledger as $row): 
                                ...
                                if ($row['txn_type'] == 'Vaccination') { $badgeClass = 'type-usage'; $icon = 'fa-shield-virus'; }
