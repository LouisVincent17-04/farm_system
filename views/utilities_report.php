...
checkAccess('utilities_consumable_report');
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body {
            ...
            background-image:
                ...
                radial-gradient(ellipse 40% 30% at 85% 10%, rgba(129,140,248,0.04) 0%, transparent 50%);
        }
        ...
        .stat-card.indigo::before { background: linear-gradient(135deg, rgba(129,140,248,0.04), transparent); }
        ...
        .stat-card.indigo { border-color: rgba(129,140,248,0.15); }
        ...
        .filter-badge {
            ...
            background: var(--blue); color: #fff; border-radius: 99px; padding: 0 6px;
        }
        .filter-toggle-btn {
        ...
        .btn-primary:hover { background: #2563eb; box-shadow: 0 0 16px var(--blue-glow); color: #fff; }
        ...
        .val-count { font-family: var(--font-mono); color: var(--indigo); font-size: 0.85rem; font-weight: 600; }
...
<div class="container">
    ...
    <div class="top-bar">
        ...
        <span class="page-badge"><i class="fa-solid fa-bolt"></i> Utilities & Consumables</span>
    </div>

    <div class="page-header">
        <h1 class="page-title">Utilities <span>& Consumables</span> Report</h1>
        <p class="page-subtitle">Log of utilities, fuel, water, and general consumables.</p>
    </div>

    <div class="stats-grid">
        <div class="stat-card blue">
            <div class="stat-icon blue"><i class="fa-solid fa-boxes-packing"></i></div>
            <div class="stat-val blue"><?= number_format($unique_items_count) ?></div>
            <div class="stat-lbl">Unique Items</div>
        </div>
        <div class="stat-card indigo">
            <div class="stat-icon indigo"><i class="fa-solid fa-boxes-stacked"></i></div>
            <div class="stat-val indigo"><?= number_format($total_units) ?></div>
    ...
    <div class="filter-panel">
            ...
            <form method="GET" id="filterForm">
                <div class="filter-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="search" class="form-control" placeholder="e.g. LPG, Water, Diesel" value="<?= htmlspecialchars($search_term) ?>">
                    </div>
        ...
        <div class="filter-footer">
            <div class="filter-footer-left">
                <a href="utilities_report.php" class="btn btn-ghost btn-sm">
                        ...
                        <tr>
                            <td colspan="7">
                                <div class="empty-state">
                                    ...
                                    <p>No utility records found matching your filters.</p>
                                </div>
                            </td>
                        </tr>
                    <?php else: ?>
...
<script>
    ...
    function exportPDF() {
        ...
        doc.setFontSize(16); doc.setTextColor(59, 130, 246); // Blue
        doc.text("Utilities & Consumables Report", 14, 14);
