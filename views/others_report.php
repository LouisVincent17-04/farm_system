    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .title { 
            ...
            font-weight: 800; 
            background: linear-gradient(135deg, #a1a1aa, #71717a); /* Zinc/Gray */
        ...
        .form-input:focus { border-color: #a1a1aa; }
        ...
        th { 
            background: rgba(15, 23, 42, 0.9); color: #d4d4d8; 
...
<div class="container">
    ...
    <div class="header">
        <h1 class="title">Miscellaneous Items Report</h1>
        <p class="subtitle">Log of uncategorized or general farm items (Others).</p>
    </div>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-val text-zinc"><?= number_format($total_units) ?></div>
        </div>
        <div class="stat-card">
        ...
        <form method="GET">
            <div class="filter-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="search" class="form-input" placeholder="e.g. Misc Tool, Excess" value="<?= htmlspecialchars($search_term) ?>">
                </div>
                
                <div class="btn-group">
                    <button type="submit" class="btn btn-primary">Apply Filters</button>
                    <a href="others_report.php" class="btn btn-outline">Reset</a>
                </div>
            </div>
    ...
    <div class="table-wrap">
        <table>
            ...
            <tbody>
                <?php if(empty($items)): ?>
                    <tr><td colspan="7" style="text-align:center; padding:3rem; color:#64748b;">No miscellaneous items found.</td></tr>
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td data-label="Quantity" style="text-align:right; font-weight:bold; color:#d4d4d8;">
                            <?= number_format($i['QUANTITY']) ?>
                        </td>
                        <td data-label="Unit Cost" style="text-align:right;">₱<?= number_format($i['UNIT_COST'], 2) ?></td>
                        <td data-label="Total Cost" style="text-align:right; color:#a1a1aa;">₱<?= number_format($i['CALCULATED_TOTAL'], 2) ?></td>
                    </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
...
<script>
    ...
    function exportPDF() {
        ...
        doc.setFontSize(18);
        doc.setTextColor(113, 113, 122); // Zinc
        doc.text("Miscellaneous Items Report", 14, 15);
        ...
        doc.autoTable({
            ...
            startY: 30,
            styles: { fontSize: 8 },
            headStyles: { fillColor: [82, 82, 91] } // Zinc Header
        });
