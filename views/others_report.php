...
<head>
    ...
    <style>
        ...
        .form-input:focus { border-color: #a1a1aa; outline: none; }
            ...
            <tbody>
                ...
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; font-weight:bold; color:#d4d4d8;">
                            <?= number_format($i['QUANTITY']) ?>
                        </td>
                        <td style="text-align:right;">₱<?= number_format($i['UNIT_COST'], 2) ?></td>
                        <td style="text-align:right; color:#a1a1aa;">₱<?= number_format($i['CALCULATED_TOTAL'], 2) ?></td>
                    </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
