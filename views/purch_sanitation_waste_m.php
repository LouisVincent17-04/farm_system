...
<head>
    ...
    <title>Sanitation & Waste Management | FarmPro</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-primary:hover { background: #2dd4bf; box-shadow: 0 0 16px var(--teal-glow); transform: translateY(-1px); }
        ...
        .action-btn.edit:hover { color: var(--teal); border-color: var(--teal); }
...
<div class="container">
    ...
    <div class="top-bar">
        ...
        <span class="page-badge"><i class="fa-solid fa-broom"></i> Hygiene & Biosecurity</span>
    </div>

    <div class="page-header">
        <div class="header-info">
            <h1>Sanitation <span>&amp; Waste</span></h1>
            <p>Log and manage hygiene, cleaning, and biosecurity acquisitions.</p>
        </div>
                        ...
                        <tr>
                            <td colspan="12">
                                <div class="empty-state">
                                    ...
                                    No sanitation & waste purchases recorded yet in this location.
                                </div>
                            </td>
                        </tr>
                    <?php else: ?>
...
<script>
    ...
    function submitConfirmation() {
        ...
        fetch('../purchase_confirmations/confirmSanitationAndWasteM.php', { method: 'POST', body: formData })
            .then(r => r.json())
            .then(data => {
    ...
    function submitConfirmAll() {
        ...
        fetch('../purchase_confirmations/confirmAllSanitationAndWasteM.php', { method: 'POST' })
            .then(r => r.json())
            .then(data => {
                if (data.success) { showToast(data.message, 'success'); setTimeout(() => window.location.reload(), 1000); } 
