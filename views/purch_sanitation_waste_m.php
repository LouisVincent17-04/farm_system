<?php
// views/purch_sanitation_waste_m.php
error_reporting(0);
...
<head>
    ...
    <title>Sanitation & Waste Purchase Management</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header-info h1 { font-size: clamp(1.8rem, 4vw, 2.5rem); font-weight: bold; margin-bottom: 0.5rem; line-height: 1.2; color: #34d399; }
        ...
        .add-btn { background: linear-gradient(135deg, #10b981, #059669); color: white; }
        .add-btn:hover { background: linear-gradient(135deg, #059669, #047857); transform: translateY(-2px); }
        ...
        .ref-no { font-family: monospace; color: #34d399; font-size: 0.95rem; font-weight: 600; }
        ...
        .action-btn.view:hover { background: rgba(52, 211, 153, 0.2); color: #34d399; border-color: #10b981; }
        ...
        .info-group h3 { color: #34d399; font-size: 1.1rem; margin-bottom: 15px; margin-top: 20px; border-bottom: 1px solid #334155; padding-bottom: 5px; }
        ...
        .btn-save { padding: 12px 20px; background: #10b981; border: none; color: white; border-radius: 8px; cursor: pointer; font-weight: 600; transition: background 0.2s; }
        ...
        .autocomplete-item strong { color: #34d399; }
...
<body>
    <div class="container">
        ...
        <div class="header">
            <div class="header-info">
                <h1>Sanitation & Waste Supplies</h1>
                <p>Manage and track sanitation and waste management purchases</p>
            </div>
                    ...
                    <?php else: ?>
                        ...
                        <tr data-item-id="<?php echo $item['ITEM_ID']; ?>"
                            ...
                            <td data-label="Total Cost">
                                <div class="amount" style="font-weight:bold; color:#34d399;">₱<?php echo number_format($totalCost, 2); ?></div>
                            </td>
                ...
                <form id="item-form" method="POST">
                    ...
                    <div class="info-group" style="margin-top: 0;">
                        ...
                        <div class="form-group autocomplete-wrapper">
                            ...
                            <input type="text" id="item-name" name="item_name" placeholder="e.g., Disinfectant, Broom, Waste Bin" required maxlength="300" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group autocomplete-wrapper">
                                ...
                                <input type="text" id="supplier" name="supplier" placeholder="e.g., CleanPro Supplies" autocomplete="off">
    ...
    <div id="confirm-modal" class="modal">
        <div class="modal-content" style="max-width: 450px;">
            <div class="modal-body confirm-content">
                ...
                <p style="color: #94a3b8; margin-bottom: 5px;">You are about to confirm <strong><span id="confirm-item-qty"></span> <span id="confirm-item-name" style="color: #34d399;"></span></strong>.</p>
    ...
    <div id="confirm-all-modal" class="modal">
        <div class="modal-content" style="max-width: 450px;">
            <div class="modal-body confirm-content">
                ...
                <p style="color: #94a3b8;">This will confirm and lock <strong>ALL</strong> currently pending sanitation and waste supply purchases.</p>
                <div class="warning-text">
    ...
    <script>
        ...
        function submitConfirmation() {
            ...
            fetch('../purchase_confirmations/confirmSanitationAndWasteM.php', {
                method: 'POST',
                body: formData
            })
        ...
        function submitConfirmAll() {
            ...
            fetch('../purchase_confirmations/confirmAllSanitationAndWasteM.php', {
                method: 'POST'
            })
            .then(response => response.json())
            .then(data => {
        ...
        function fetchAutocomplete(searchTerm) {
            fetch(`../process/searchSanitationAndWasteM.php?term=${encodeURIComponent(searchTerm)}`)
                .then(response => response.json())
        ...
        function viewItem(button) {
            ...
            const html = `
                <div class="info-group">
                    <h3 style="border-bottom:1px solid #334155; padding-bottom:5px; color:#34d399;">Basic Information</h3>
                ...
                <div class="info-group" style="margin-top:20px;">
                    <h3 style="border-bottom:1px solid #334155; padding-bottom:5px; color:#34d399;">Purchase Details</h3>
        ...
        function editItem(button) {
            ...
            document.getElementById('modal-title').textContent = 'Edit Sanitation/Waste Supply Purchase';
