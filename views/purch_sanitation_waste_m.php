<?php
// views/purch_sanitation_waste_management.php
error_reporting(0);
...
<head>
    ...
    <title>Sanitation & Waste Management</title>
...
<body>
    <div class="container">
        <div class="header">
            <div class="header-info">
                <h1>Sanitation & Waste</h1>
                <p>Manage and track sanitation and waste supplies</p>
            </div>
            ...
            <table class="table">
                ...
                <tbody id="item-table">
                    ...
                    <tr data-item-id="<?php echo $item['ITEM_ID']; ?>"
                        ...
                        <td>
                            <div class="item-id">SNT-<?php echo str_pad($item['ITEM_ID'], 4, '0', STR_PAD_LEFT); ?></div>
                        </td>
                        <td>
    ...
    <div id="modal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 id="modal-title">Add Sanitation & Waste Purchase</h2>
            </div>
                ...
                <form id="item-form" method="POST">
                    ...
                    <div class="info-group">
                        ...
                        <div class="form-group autocomplete-wrapper">
                            ...
                            <input type="text" id="item-name" name="item_name" placeholder="e.g., Disinfectant" required maxlength="300" autocomplete="off">
    ...
    <div id="confirm-all-modal" class="modal">
        <div class="modal-content" style="max-width: 450px;">
            <div class="modal-body confirm-content">
                ...
                <p style="color: #64748b;">This will confirm and lock <strong>ALL</strong> currently pending sanitation purchases.</p>
                <div class="warning-text">
    ...
    <form id="deleteItemForm" method="POST" action="../process/deleteSanitationPurchase.php" style="display: none;">
    ...
    <script>
        ...
        function fetchAutocomplete(searchTerm) {
            fetch(`../process/searchSanitationPurchase.php?term=${encodeURIComponent(searchTerm)}`)
                .then(response => response.json())
        ...
        function openAddModal() {
            document.getElementById('modal-title').textContent = 'Add Sanitation & Waste Purchase';
