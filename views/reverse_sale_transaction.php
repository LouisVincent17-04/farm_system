...
try {
    ...
    // We group by sale_date to identify batches
    $sql = "SELECT 
                s.sale_date,
...
<head>
    ...
    <title>Reverse Sales | FarmPro</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-select:focus { border-color: var(--gold); box-shadow: 0 0 0 3px rgba(245,158,11,0.15); background: var(--bg-hover); }
        ...
        .info-val.highlight { color: var(--gold); }
...
<div class="container">
    ...
    <div class="page-header">
        <h1 class="page-title"><i class="fa-solid fa-clock-rotate-left" style="color:var(--red);"></i> Admin <span>Undo</span> Sale</h1>
        <p class="page-desc">Select a historical sales batch to cancel the transaction and restore animals to active inventory.</p>
    </div>
        ...
        <div class="main-grid">
            ...
            <div class="control-panel">
                ...
                <div class="alert-box">
                    ...
                    <div>
                        <strong>Warning:</strong> This action is permanent. Reversing a batch will completely delete its transaction records, remove the revenue from the ledger, and mark the animals as 'Active' again.
                    </div>
                </div>
            </div>
            ...
            <div id="detailsPanel" class="details-panel">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-row">
                        <span class="info-lbl">Buyer / Customer</span>
                        <span class="info-val highlight" id="lbl_buyer" style="font-family: var(--font); font-size: 0.95rem;">—</span>
                    </div>
                    <div class="info-row">
                    ...
                    <div class="info-row">
                        <span class="info-lbl">Total Revenue</span>
                        <span class="info-val" id="lbl_revenue" style="color:var(--emerald);">—</span>
                    </div>
                </div>
...
<script>
    ...
    function handleBatchSelection() {
        ...
        if (batch) {
            ...
            document.getElementById('lbl_buyer').textContent = batch.customer_name || 'Multiple / Unknown';
            document.getElementById('lbl_count').textContent = batch.record_count + ' Heads';
            document.getElementById('lbl_revenue').textContent = '₱ ' + parseFloat(batch.total_revenue).toLocaleString('en-PH', {minimumFractionDigits:2});
    ...
    function confirmReversal() {
        ...
        if(!confirm(`DANGER: Are you absolutely sure you want to cancel this sales batch?\n\nThis will permanently remove the transactions from the ledger and restore the animals to the farm.`)) {
            return;
        }
