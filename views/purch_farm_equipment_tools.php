...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .action-btn.view:hover { color: var(--indigo); border-color: var(--indigo); }
                    ...
                    <div class="form-stack">
                        ...
                        <div class="form-group full-width autocomplete-wrapper">
                            ...
                            <input type="text" id="item-name" name="item_name" class="form-control" 
                                   placeholder="e.g., Heavy Duty Rake" required maxlength="300" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group autocomplete-wrapper">
                                ...
                                <input type="text" id="supplier" name="supplier" class="form-control" 
                                       placeholder="e.g., AgriBuild Inc." autocomplete="off">
...
<script>
    ...
    function openAddModal() {
        document.getElementById('modal-title').textContent = 'Add Equipment Purchase';
