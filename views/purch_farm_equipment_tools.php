...
<body>
            ...
            <table class="table">
                ...
                <tbody id="item-table">
                    ...
                    <tr data-item-id="<?php echo $item['ITEM_ID']; ?>"
                        ...
                        <td>
                            <div class="item-id">EQP-<?php echo str_pad($item['ITEM_ID'], 4, '0', STR_PAD_LEFT); ?></div>
                        </td>
                        <td>
    ...
    <div id="confirm-all-modal" class="modal">
        <div class="modal-content" style="max-width: 450px;">
            <div class="modal-body confirm-content">
                ...
                <p style="color: #64748b;">This will confirm and lock <strong>ALL</strong> currently pending equipment/tools purchases.</p>
                <div class="warning-text">
    ...
    <form id="deleteItemForm" method="POST" action="../process/deleteFarmEquipmentAndTools.php" style="display: none;">
    ...
    <script>
        ...
        function submitConfirmation() {
            ...
            fetch('../purchase_confirmations/confirmFarmEquipmentAndTools.php', {
                method: 'POST',
                body: formData
            })
        ...
        function submitConfirmAll() {
            ...
            fetch('../purchase_confirmations/confirmAllFarmEquipmentAndTools.php', {
                method: 'POST'
            })
            .then(response => response.json())
            .then(data => {
        ...
        function fetchAutocomplete(searchTerm) {
            fetch(`../process/searchFarmEquipmentAndTools.php?term=${encodeURIComponent(searchTerm)}`)
                .then(response => response.json())
        ...
        function openAddModal() {
            document.getElementById('modal-title').textContent = 'Add Farm Equipment/Tools Purchase';
        ...
        function populateEditForm(data) {
            document.getElementById('modal-title').textContent = 'Edit Farm Equipment/Tools Purchase';
        ...
        function saveItem() {
            ...
            const url = isEdit ? '../process/editFarmEquipmentAndTools.php' : '../process/addFarmEquipmentAndTools.php';
