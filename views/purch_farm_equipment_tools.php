...
<head>
    ...
    <title>Farm Equipment & Tools Management | FarmPro</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .info-group h3 { font-size: 0.9rem; text-transform: uppercase; letter-spacing: 0.05em; color: var(--indigo); margin: 1.5rem 0 1rem 0; border-bottom: 1px solid var(--border); padding-bottom: 8px; }
...
<div class="container">
    ...
    <div class="top-bar">
        ...
        <span class="page-badge"><i class="fa-solid fa-toolbox"></i> Hardware & Tools</span>
    </div>

    <div class="page-header">
        <div class="header-info">
            <h1>Farm Equipment <span>&amp; Tools</span></h1>
            <p>Log and manage machinery, implements, and hardware acquisitions.</p>
        </div>
                        ...
                        <tr>
                            <td colspan="12">
                                <div class="empty-state">
                                    ...
                                    No equipment purchases recorded yet in this location.
                                </div>
                            </td>
                        </tr>
                    <?php else: ?>
...
<div id="modal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            <h2 id="modal-title">Add Equipment/Tools Purchase</h2>
        </div>
            ...
            <form id="item-form" method="POST">
                ...
                <div class="info-group" style="margin-top: 0;">
                    ...
                    <div class="form-group autocomplete-wrapper">
                        ...
                        <input type="text" id="item-name" name="item_name" class="form-control" placeholder="e.g., Heavy Duty Rake" required maxlength="300" autocomplete="off">
...
<div id="confirm-modal" class="modal">
    <div class="modal-content" style="max-width: 450px;">
        <div class="modal-body confirm-content">
            <span class="confirm-icon" style="color:var(--indigo);">⚙️</span>
...
<div id="confirm-all-modal" class="modal">
    <div class="modal-content" style="max-width: 450px;">
        <div class="modal-body confirm-content">
            ...
            <p style="color: var(--text-secondary);">This function will verify and lock <strong>ALL</strong> currently pending equipment purchases in this location.</p>
...
<script>
    ...
    function openAddModal() {
        document.getElementById('modal-title').textContent = 'Add Equipment/Tools Purchase';
    ...
    function editItem(button) {
        ...
        document.getElementById('modal-title').textContent = 'Edit Equipment Purchase';
