...
<head>
    ...
    <title>Farm Equipment & Tools Management</title>
    ...
    <div class="container">
        ...
        <div class="header">
            <div class="header-info">
                <h1>Farm Equipment & Tools</h1>
                <p>Manage and track farm equipment and tools purchases</p>
            </div>
    ...
    <div id="modal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 id="modal-title">Add Farm Equipment/Tools Purchase</h2>
            </div>
                ...
                <form id="item-form" method="POST">
                    ...
                    <div class="info-group" style="margin-top: 0;">
                        ...
                        <div class="form-group autocomplete-wrapper">
                            ...
                            <input type="text" id="item-name" name="item_name" placeholder="e.g., Garden Rake" required maxlength="300" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group autocomplete-wrapper">
                                ...
                                <input type="text" id="supplier" name="supplier" placeholder="e.g., Tractor Supply Co." autocomplete="off">
