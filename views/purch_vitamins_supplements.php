...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .item-name { font-weight: 600; color: white; font-size: 1rem; }
...
<body>
    <div class="container">
        ...
        <div class="header">
            <div class="header-info">
                <h1>Vitamin Purchase</h1>
                <p>Manage and track vitamin & supplement purchases</p>
            </div>
                ...
                <form id="item-form" method="POST">
                    ...
                    <div class="info-group">
                        ...
                        <div class="form-group autocomplete-wrapper">
                            ...
                            <input type="text" id="item-name" name="item_name" placeholder="e.g., Vitamin C Supplement" required maxlength="300" autocomplete="off">
    ...
    <form id="deleteItemForm" method="POST" action="../process/deleteVitaminsAndSupplements.php" style="display: none;"><input type="hidden" id="delete_item_id" name="item_id"></form>
    ...
    <script>
        ...
        function openAddModal() {
            ...
            // Use API to reliably set current date natively on Flatpickr
            fpPurchaseDate.setDate(new Date()); 
            fpExpirationDate.clear(); // Set expiry to blank initially
        ...
        function deleteItem(btn) {
            ...
            fetch('../process/deleteVitaminsAndSupplements.php', { method:'POST', body:fd })
            .then(r => r.json()).then(data => {
                alert(data.message);
