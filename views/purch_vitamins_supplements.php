...
try {
    ...
    // 1. Fetch Items based on Location Access (Added EXPIRATION_DATE)
...
<head>
    ...
    <title>Vitamin Purchase Management | FarmPro</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        body {
            ...
            min-height: 100vh;
            padding-bottom: 60px;
            background-image: radial-gradient(ellipse 80% 50% at 50% -20%, rgba(16,185,129,0.05) 0%, transparent 60%);
        }
        ...
        .form-control:focus, .form-select:focus, textarea.form-control:focus { border-color: var(--emerald); box-shadow: 0 0 0 3px var(--emerald-glow); background: var(--bg-hover); }
        ...
        .info-group h3 { font-size: 0.9rem; text-transform: uppercase; letter-spacing: 0.05em; color: var(--emerald); margin: 1.5rem 0 1rem 0; border-bottom: 1px solid var(--border); padding-bottom: 8px; }
        ...
        .autocomplete-item:hover { background: var(--bg-hover); color: var(--emerald); }
        .autocomplete-item strong { color: var(--emerald); }
...
<div class="container">
    ...
    <div class="top-bar">
        ...
        <span class="page-badge"><i class="fa-solid fa-seedling"></i> Nutritional Inventory</span>
    </div>

    <div class="page-header">
        <div class="header-info">
            <h1>Vitamin <span>Purchases</span></h1>
            <p>Log and manage incoming vitamin and supplement acquisitions before structural assignment.</p>
        </div>
    ...
    <div class="search-container">
        ...
        <input type="text" class="search-input" id="searchInput" placeholder="Quick search by vitamin name, supplier, or reference no..." onkeyup="filterTable()">
    </div>
                        ...
                        <tr>
                            <td colspan="13">
                                <div class="empty-state">
                                    ...
                                    No vitamin purchases recorded yet in this location.
                                </div>
                            </td>
                        </tr>
                    <?php else: ?>
            ...
            <form id="item-form" method="POST">
                ...
                <div class="info-group" style="margin-top: 0;">
                    ...
                    <div class="form-group autocomplete-wrapper">
                        <label class="form-label" for="item-name">Name <span>*</span></label>
                        <input type="text" id="item-name" name="item_name" class="form-control" placeholder="e.g., Vitamin C Supplement" required maxlength="300" autocomplete="off">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" id="net-weight" name="item_net_weight" class="form-control" placeholder="e.g., 0.5" step="0.01" min="0">
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="unit">Unit <span>*</span></label>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label class="form-label" for="purchase-date">Date <span>*</span></label>
                ...
                <div class="info-group">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select id="location_id" name="location_id" class="form-select" onchange="filterBuildings()" <?php echo ($USER_LOCATION_ != 1000) ? 'style="background-color: #1e293b; pointer-events: none; color: #94a3b8;"' : ''; ?> required>
...
<div id="confirm-all-modal" class="modal">
    <div class="modal-content" style="max-width: 450px;">
        <div class="modal-body confirm-content">
            ...
            <p style="color: var(--text-secondary);">This function will verify and lock <strong>ALL</strong> currently pending vitamin purchases in this location.</p>
...
<form id="deleteItemForm" method="POST" action="../process/deleteVitaminsAndSupplements.php" style="display: none;">
...
<script>
    ...
    function submitConfirmation() {
        ...
        fetch('../purchase_confirmations/confirmVitaminsAndSupplements.php', { method: 'POST', body: formData })
            .then(r => r.json())
            .then(data => {
    ...
    function fetchAutocomplete(searchTerm) {
        fetch(`../process/searchVitaminsAndSupplements.php?term=${encodeURIComponent(searchTerm)}`)
    ...
    function saveItem() {
        ...
        const url = isEdit ? '../process/editVitaminsAndSupplements.php' : '../process/addVitaminsAndSupplements.php';
