                    ...
                    <div class="form-stack">
                        ...
                        <div class="form-group full-width autocomplete-wrapper">
                            ...
                            <input type="text" id="item-name" name="item_name" class="form-control" 
                                   placeholder="e.g., Vitamin C Supplement" required maxlength="300" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" id="net-weight" name="item_net_weight" class="form-control" 
                                       placeholder="e.g., 0.5" step="0.01" min="0">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label class="form-label" for="purchase-date">Purchase Date <span>*</span></label>
    ...
    <div class="modal-content narrow">
        <div class="modal-body confirm-content">
            ...
            <p style="color: var(--text-secondary); margin-bottom: 5px;">
                You are confirming the intake of <strong><span id="confirm-item-qty"></span> <span id="confirm-item-name" style="color:var(--emerald);"></span></strong>.
            </p>
    ...
    <div class="modal-content narrow">
        <div class="modal-body confirm-content">
            ...
            <p style="color: var(--text-secondary);">
                This function will verify and lock <strong>ALL</strong> currently pending vitamin purchases in this location.
            </p>
