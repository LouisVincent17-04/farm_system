...
try {
    ...
    // Spending on sanitation over the last 12 months
    $trend_sql = "SELECT 
    ...
    // Most abundant sanitation supplies
...
<head>
    ...
    <style>
        ...
        .title { 
            ...
            background: linear-gradient(135deg, #a78bfa, #7c3aed); /* Purple Gradient */
        ...
        .btn { 
            padding: 10px 20px; background: rgba(139, 92, 246, 0.1); 
            color: #a78bfa; border: 1px solid rgba(139, 92, 246, 0.3); 
            border-radius: 8px; text-decoration: none; font-weight: 600; 
            transition: all 0.2s; 
        }
        .btn:hover { background: rgba(139, 92, 246, 0.2); transform: translateY(-2px); }
...
<div class="container">
    ...
    <div class="kpi-grid">
        ...
        <div class="kpi-card">
            <div class="kpi-label">Avg. Cost / Item</div>
            <div class="kpi-value text-violet">₱<?= number_format($avg_cost, 2) ?></div>
    ...
    <div class="charts-container">
        ...
        <div class="chart-box">
            <div class="chart-title">📉 Sanitation Spending (Last 12 Months)</div>
        ...
        <div class="chart-box" style="grid-column: 1 / -1;">
            <div class="chart-title">📊 Top 5 Supplies by Quantity</div>
    ...
    new Chart(document.getElementById('distChart'), {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: ['#7c3aed', '#8b5cf6', '#a78bfa', '#c4b5fd', '#ddd6fe'], // Purple shades
                borderWidth: 0
            }]
        },
        options: {
    ...
    new Chart(document.getElementById('qtyChart'), {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: 'rgba(167, 139, 250, 0.7)', // Light Purple
                borderColor: '#8b5cf6',
                borderWidth: 1,
                borderRadius: 4
            }]
