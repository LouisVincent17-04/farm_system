<?php
// reports/analytics_sanitation_waste_m.php
error_reporting(0);
...
<head>
    ...
    <title>Sanitation Analytics | FarmPro</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .header-info h1 span { background: linear-gradient(135deg, var(--purple), #7e22ce); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
        ...
        .btn-view:hover { background: var(--purple-dim); border-color: var(--purple); color: #fff; transform: translateY(-2px);}
        ...
        .stat-violet .kpi-icon { background: linear-gradient(135deg, var(--violet), #6d28d9); }
        ...
        .stat-violet .kpi-value { color: var(--violet); }
...
<div class="container">
    ...
    <header class="page-header">
        <div class="header-info">
            <h1>Sanitation & Waste <span>Analytics</span></h1>
            <p>Hygiene supplies, waste management assets, and spending overview.</p>
        </div>
        <a href="sanitation_report.php" class="btn-view"><i class="fa-solid fa-file-invoice"></i> View Detailed Report</a>
    </header>
    ...
    <div class="kpi-grid">
        ...
        <div class="kpi-card stat-violet">
            <div class="kpi-header">
                <div class="kpi-title">Distinct Items</div>
                <div class="kpi-icon"><i class="fa-solid fa-soap"></i></div>
            </div>
        ...
        <div class="kpi-card stat-blue">
            <div class="kpi-header">
                <div class="kpi-title">Avg. Cost</div>
    ...
    <div class="charts-container">
        <div class="chart-box">
            <div class="chart-title"><i class="fa-solid fa-chart-line" style="color:var(--purple);"></i> Sanitation Spending (Last 12 Months)</div>
        ...
        <div class="chart-box">
            <div class="chart-title"><i class="fa-solid fa-chart-pie" style="color:var(--violet);"></i> Value Distribution by Item</div>
            <div class="chart-canvas-wrapper">
        ...
        <div class="chart-box full-width">
            <div class="chart-title"><i class="fa-solid fa-list-ol" style="color:var(--emerald);"></i> Top 5 Supplies by Quantity</div>
    ...
    new Chart(document.getElementById('distChart'), {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: ['#a855f7', '#9333ea', '#7e22ce', '#6b21a8', '#581c87'], // Purple palette
                borderWidth: 0,
                hoverOffset: 6
            }]
        },
