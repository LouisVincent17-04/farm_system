<?php
// views/reverse_vitamin_transaction.php
...
try {
    ...
    $sql = "SELECT 
                vt.TRANSACTION_DATE,
                MAX(vt.ADMINISTERED_BY) as ADMINISTERED_BY,
                COUNT(vt.VST_ID) as record_count,
                GROUP_CONCAT(DISTINCT v.SUPPLY_NAME SEPARATOR ', ') as items_used,
                SUM(vt.QUANTITY_USED) as total_qty,
...
<head>
    ...
    <title>Reverse Vitamins | FarmPro</title>
...
<div class="container">
    ...
    <div class="page-header">
        <h1 class="page-title"><i class="fa-solid fa-clock-rotate-left" style="color:var(--red);"></i> Admin <span>Undo</span> Vitamin Transaction</h1>
        <p class="page-desc">Select a historical vitamin/supplement batch to permanently delete its records and restore inventory.</p>
    </div>
    ...
    <?php if (empty($batches) && empty($message)): ?>
        <div class="empty-state">
            ...
            <p>There are no supplement records available to reverse.</p>
        </div>
    <?php else: ?>
        <div class="main-grid">
            ...
            <div class="control-panel">
                ...
                <div class="alert-box">
                    ...
                    <div>
                        <strong>Warning:</strong> This action is permanent. Reversing a batch will completely delete its transaction records and re-add the used quantities back into your inventory.
                    </div>
                </div>
            </div>
            ...
            <div id="detailsPanel" class="details-panel">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-row">
                        <span class="info-lbl">Supplements Used</span>
...
<script>
    ...
    function confirmReversal() {
        ...
        if(!confirm(`DANGER: Are you absolutely sure you want to delete this vitamin batch?\n\nThis will permanently remove the transactions from the ledger and restore the inventory.`)) {
            return;
        }
