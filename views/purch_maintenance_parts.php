...
<head>
    ...
    <title>Maintenance Parts Management</title>
    ...
    <div class="container">
        ...
        <div class="header">
            <div class="header-info">
                ...
                <p>Manage and track maintenance parts purchases</p>
            </div>
                ...
                <form id="item-form" method="POST">
                    ...
                    <div class="info-group" style="margin-top: 0;">
                        ...
                        <div class="form-group autocomplete-wrapper">
                            ...
                            <input type="text" id="item-name" name="item_name" placeholder="e.g., Replacement Belt" required maxlength="300" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group autocomplete-wrapper">
                                ...
                                <input type="text" id="supplier" name="supplier" placeholder="e.g., FixIt Supplies" autocomplete="off">
    ...
    <div id="confirm-all-modal" class="modal">
        <div class="modal-content" style="max-width: 450px;">
            <div class="modal-body confirm-content">
                ...
                <p style="color: #94a3b8;">This will confirm and lock <strong>ALL</strong> currently pending maintenance parts purchases.</p>
                <div class="warning-text">
    ...
    <script>
        ...
        function submitConfirmation() {
            ...
            .then(r => r.json()).then(d => { 
                ...
                else { confirmBtn.disabled = false; confirmBtn.innerHTML = 'Yes, Confirm it!'; }
            }).catch(() => {
        ...
        function submitConfirmAll() {
            ...
            .then(r => r.json()).then(d => { 
                alert(d.message); 
                if(d.success) window.location.reload(); 
                else { confirmBtn.disabled = false; confirmBtn.innerHTML = 'Confirm All'; }
            }).catch(() => {
                alert("An error occurred.");
        ...
        function editItem(button) {
            ...
            const data = {
                item_id: row.dataset.itemId, item_name: row.dataset.itemName, item_description: row.dataset.itemDesc,
                unit_id: row.dataset.unitId, unit_cost: row.dataset.unitCost, item_category: row.dataset.itemCategory,
                net_weight: row.dataset.netWeight, quantity: row.dataset.quantity, purchase_date_raw: row.dataset.purchaseDateRaw,
                location_id: row.dataset.locationId, building_id: row.dataset.buildingId, pen_id: row.dataset.penId,
                supplier: row.dataset.supplier, reference_no: row.dataset.referenceNo
            };
        ...
        function deleteItem(button) {
            const row = button.closest('tr');
            if (confirm(`Are you sure you want to delete "${row.dataset.itemName}"? This action cannot be undone.`)) {
