...
// --- CONFIGURATION ---
$ITEM_TYPE_ID = 8; // Maintenance & Spare Parts
// ---------------------
...
<head>
    ...
    <title>Maintenance & Spare Parts Management</title>
    <link rel="stylesheet" href="../css/purch_maintenance_parts.css">
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <div class="header-info">
                <h1>Maintenance & Spare Parts</h1>
                <p>Manage and track maintenance and spare parts purchases</p>
            </div>
            ...
            <table class="table">
                ...
                <tbody id="item-table">
                    ...
                    <tr data-item-id="<?php echo $item['ITEM_ID']; ?>"
                        ...
                        <td>
                            <div class="item-id">MNT-<?php echo str_pad($item['ITEM_ID'], 4, '0', STR_PAD_LEFT); ?></div>
                        </td>
                        <td>
    ...
    <div id="modal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 id="modal-title">Add Maintenance & Spare Parts Purchase</h2>
            </div>
                ...
                <form id="item-form" method="POST">
                    ...
                    <div class="info-group">
                        ...
                        <div class="form-group autocomplete-wrapper">
                            ...
                            <input type="text" id="item-name" name="item_name" placeholder="e.g., Lubricants & Oils" required maxlength="300" autocomplete="off">
    ...
    <div id="confirm-all-modal" class="modal">
        <div class="modal-content" style="max-width: 450px;">
            <div class="modal-body confirm-content">
                ...
                <p style="color: #64748b;">This will confirm and lock <strong>ALL</strong> currently pending maintenance purchases.</p>
                <div class="warning-text">
    ...
    <form id="deleteItemForm" method="POST" action="../process/deleteMaintenanceAndParts.php" style="display: none;">
    ...
    <script>
        ...
        function submitConfirmation() {
            ...
            fetch('../purchase_confirmations/confirmMaintenanceAndParts.php', {
                method: 'POST',
                body: formData
            })
        ...
        function submitConfirmAll() {
            ...
            fetch('../purchase_confirmations/confirmAllMaintenanceAndParts.php', {
                method: 'POST'
            })
            .then(response => response.json())
            .then(data => {
        ...
        function openAddModal() {
            document.getElementById('modal-title').textContent = 'Add Maintenance & Spare Parts Purchase';
        ...
        function populateEditForm(data) {
            document.getElementById('modal-title').textContent = 'Edit Maintenance & Spare Parts Purchase';
