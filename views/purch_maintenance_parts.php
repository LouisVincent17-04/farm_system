                    ...
                    <div class="form-stack">
                        ...
                        <div class="form-group full-width autocomplete-wrapper">
                            ...
                            <input type="text" id="item-name" name="item_name" class="form-control" 
                                   placeholder="e.g., Replacement Belt, Motor" required maxlength="300" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group autocomplete-wrapper">
                                ...
                                <input type="text" id="supplier" name="supplier" class="form-control" 
                                       placeholder="e.g., Industrial Tools Corp" autocomplete="off">
    ...
    <div class="modal-content narrow">
        <div class="modal-body confirm-content">
            ...
            <p style="color: var(--text-secondary); margin-bottom: 5px;">
                You are confirming the intake of <strong><span id="confirm-item-qty"></span> <span id="confirm-item-name" style="color:var(--accent);"></span></strong>.
            </p>
    ...
    <div class="modal-content narrow">
        <div class="modal-body confirm-content">
            ...
            <p style="color: var(--text-secondary);">
                This function will verify and lock <strong>ALL</strong> currently pending maintenance parts purchases in this location.
            </p>
