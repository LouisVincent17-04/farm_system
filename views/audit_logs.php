...
<head>
    ...
    <style>
        ...
        .header-info h1 { margin: 0; font-size: 2rem; color: white; }
        .header-info p { margin: 5px 0 0; color: #94a3b8; }
        ...
        .modal-content { background: #1e293b; border-radius: 12px; width: 100%; max-width: 500px; border: 1px solid #475569; display: flex; flex-direction: column; max-height: 90vh; }
        ...
        .detail-value { color: #e2e8f0; font-size: 1rem; background: rgba(0,0,0,0.2); padding: 0.75rem; border-radius: 6px; border: 1px solid #334155; word-wrap: break-word; }
        .btn-close { background: transparent; border: none; color: #cbd5e1; cursor: pointer; font-size: 1.5rem; }
                    ...
                    <?php else: ?>
                        ...
                        <tr data-json='<?php echo $logJson; ?>'>
                            ...
                            <td data-label="View" style="text-align: center;">
                                <button onclick="viewLog(this)" style="background: transparent; border: none; color: #cbd5e1; cursor: pointer; padding: 5px;">
