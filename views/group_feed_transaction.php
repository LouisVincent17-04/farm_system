...
try {
    ...
    // 3. Feeds (Fetched completely, but will be filtered by JS)
...
<body>
    <div class="container">
        <a href="group_feed_management.php" class="back-link">
    ...
    <script>
        // --- PASS PHP DATA TO JS FOR FILTERING ---
        ...
        function filterFeedsByLocation() {
            ...
            // 2. Filter feeds from the master JS array
            ...
            if (filteredFeeds.length > 0) {
                ...
                filteredFeeds.forEach(feed => {
                    ...
                    // Important: Store stock in dataset for calculation logic
