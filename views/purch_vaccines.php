...
<head>
    ...
    <title>Vaccine Purchase Management | FarmPro</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        body {
            ...
            min-height: 100vh;
            padding-bottom: 60px;
            background-image: radial-gradient(ellipse 80% 50% at 50% -20%, rgba(6,182,212,0.05) 0%, transparent 60%);
        }
...
<div class="container">
    <div class="top-bar">
        ...
        <span class="page-badge"><i class="fa-solid fa-syringe"></i> Medical Inventory</span>
    </div>
    ...
    <div class="search-container">
        ...
        <input type="text" class="search-input" id="searchInput" placeholder="Quick search by vaccine name, supplier, or reference no..." onkeyup="filterTable()">
    </div>
