        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body {
            ...
            background-image:
                ...
                radial-gradient(ellipse 40% 30% at 85% 10%, rgba(34,211,238,0.04) 0%, transparent 50%);
        }
        ...
        .stat-card.sky::before   { background: linear-gradient(135deg, rgba(56,189,248,0.04), transparent); }
        .stat-card.cyan::before  { background: linear-gradient(135deg, rgba(34,211,238,0.04), transparent); }
        ...
        .stat-card.sky   { border-color: rgba(56,189,248,0.15); }
        .stat-card.cyan  { border-color: rgba(34,211,238,0.15); }
        ...
        .filter-badge {
            ...
            background: var(--sky); color: #000; border-radius: 99px; padding: 0 6px;
        }
        .filter-toggle-btn {
        ...
        .form-label.accent { color: var(--sky); }
        ...
        .form-control:focus {
            border-color: var(--border-active); box-shadow: 0 0 0 3px var(--sky-glow);
        ...
        .btn-primary:hover { background: #0ea5e9; box-shadow: 0 0 16px var(--sky-glow); color: #fff; }
        ...
        .val-count { font-family: var(--font-mono); color: var(--sky); font-size: 0.85rem; font-weight: 600; }

        /* ─── LEDGER BUTTON ─── */
        .btn-ledger {
            display: inline-flex; align-items: center; gap: 5px;
            padding: 5px 10px; background: var(--sky-dim);
            border: 1px solid rgba(56,189,248,0.25); color: var(--sky);
        ...
        .btn-ledger:hover {
            background: rgba(56,189,248,0.22); color: #fff; border-color: var(--sky);
            transform: translateY(-1px); box-shadow: 0 4px 12px var(--sky-glow);
        }
...
<div class="container">
    ...
    <div class="top-bar">
        ...
        <span class="page-badge"><i class="fa-solid fa-syringe"></i> Vaccines</span>
    </div>

    <div class="page-header">
        <h1 class="page-title">Vaccine <span>Inventory</span> Report</h1>
        <p class="page-subtitle">Monitor vaccine supplies, stock levels, and individual history ledgers.</p>
    </div>

    <div class="stats-grid">
        <div class="stat-card sky">
            <div class="stat-icon sky"><i class="fa-solid fa-vial"></i></div>
            <div class="stat-val sky"><?= number_format($total_items) ?></div>
            <div class="stat-lbl">Unique Vaccines</div>
        </div>
        <div class="stat-card cyan">
            <div class="stat-icon cyan"><i class="fa-solid fa-boxes-stacked"></i></div>
            <div class="stat-val cyan"><?= number_format($total_stock) ?></div>
    ...
    <div class="filter-panel">
            ...
            <form method="GET" id="filterForm">
                <div class="filter-grid">
                    ...
                    <div class="form-group">
                        <label class="form-label accent"><i class="fa-solid fa-magnifying-glass"></i> Search Vaccine</label>
                        <input type="text" name="search" class="form-control" placeholder="e.g. ASF, Myco" value="<?= htmlspecialchars($search_term) ?>">
                    </div>
        ...
        <div class="filter-footer">
            <div class="filter-footer-left">
                <a href="vaccine_report.php" class="btn btn-ghost btn-sm">
                        ...
                        <tr>
                            <td colspan="7">
                                <div class="empty-state">
                                    ...
                                    <p>No vaccine records found matching your filters.</p>
                                </div>
                            </td>
                        </tr>
                    <?php else: ?>
                        ...
                        ?>
                        <tr>
                            <td data-label="Vaccine Name" class="col-name"><?= htmlspecialchars($v['SUPPLY_NAME']) ?></td>
                            ...
                            <td data-label="History" class="text-center">
                                <a href="viewVaccinesLedger.php?id=<?= $v['SUPPLY_ID']."&curr_page=vac_rep" ?>" class="btn-ledger">
...
<script>
    ...
    function exportPDF() {
        ...
        doc.setFontSize(16); doc.setTextColor(56, 189, 248); // Sky Blue
        doc.text("Vaccine Inventory Report", 14, 14);
        ...
        doc.autoTable({
            head: [['Vaccine Name', 'Stock', 'Total Cost (PHP)', 'Avg Cost (PHP)', 'Updated', 'Status']],
            body: rows, startY: 34, 
            styles: { fontSize: 8, cellPadding: 1.5 }, 
            headStyles: { fillColor: [14, 165, 233] } // Darker Sky Blue Header
        });
