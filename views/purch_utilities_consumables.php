...
<head>
    ...
    <title>Utilities & Consumables Purchase Management</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header-info h1 { font-size: clamp(1.8rem, 4vw, 2.5rem); font-weight: bold; margin-bottom: 0.5rem; line-height: 1.2; color: #60a5fa; }
        ...
        .add-btn { background: linear-gradient(135deg, #3b82f6, #2563eb); color: white; }
        .add-btn:hover { background: linear-gradient(135deg, #2563eb, #1d4ed8); transform: translateY(-2px); }
        ...
        .ref-no { font-family: monospace; color: #60a5fa; font-size: 0.95rem; font-weight: 600; }
        ...
        .action-btn.edit:hover { background: rgba(245, 158, 11, 0.2); color: #fbbf24; border-color: #f59e0b; }
        ...
        .form-group input:focus, .form-group select:focus, .form-group textarea:focus { border-color: #60a5fa; box-shadow: 0 0 0 3px rgba(96, 165, 250, 0.1); }
        
        select[disabled], input[readonly] { opacity: 0.6; cursor: not-allowed; background: #1e293b; color: #94a3b8; }

        .info-group h3 { color: #60a5fa; font-size: 1.1rem; margin-bottom: 15px; margin-top: 20px; border-bottom: 1px solid #334155; padding-bottom: 5px; }
        ...
        .btn-save { padding: 12px 20px; background: #3b82f6; border: none; color: white; border-radius: 8px; cursor: pointer; font-weight: 600; transition: background 0.2s; }
...
<body>
    <div class="container">
        ...
        <div class="header">
            <div class="header-info">
                <h1>Utilities & Consumables</h1>
                <p>Manage and track utilities and consumables purchases</p>
            </div>
                ...
                <form id="item-form" method="POST">
                    ...
                    <div class="info-group" style="margin-top: 0;">
                        ...
                        <div class="form-group autocomplete-wrapper">
                            ...
                            <input type="text" id="item-name" name="item_name" placeholder="e.g., Light Bulbs, Lubricants" required maxlength="300" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group autocomplete-wrapper">
                                ...
                                <input type="text" id="supplier" name="supplier" placeholder="e.g., General Hardware" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label for="net-weight">Net Weight/Volume</label>
    ...
    <div id="confirm-modal" class="modal">
        <div class="modal-content" style="max-width: 450px;">
            <div class="modal-body confirm-content">
                ...
                <p style="color: #94a3b8; margin-bottom: 5px;">You are about to confirm <strong><span id="confirm-item-qty"></span> <span id="confirm-item-name" style="color: #60a5fa;"></span></strong>.</p>
    ...
    <div id="confirm-all-modal" class="modal">
        <div class="modal-content" style="max-width: 450px;">
            <div class="modal-body confirm-content">
                ...
                <p style="color: #94a3b8;">This will confirm and lock <strong>ALL</strong> currently pending utilities and consumables purchases.</p>
                <div class="warning-text">
    ...
    <script>
        ...
        function submitConfirmation() {
            ...
            fetch('../purchase_confirmations/confirmUtilitiesAndConsumables.php', {
                method: 'POST',
                body: formData
            })
        ...
        function submitConfirmAll() {
            ...
            fetch('../purchase_confirmations/confirmAllUtilitiesAndConsumables.php', {
                method: 'POST'
            })
            .then(response => response.json())
            .then(data => {
        ...
        function viewItem(button) {
            ...
            const html = `
                <div class="info-group">
                    <h3 style="border-bottom:1px solid #334155; padding-bottom:5px; color:#60a5fa;">Basic Information</h3>
                ...
                <div class="info-group" style="margin-top:20px;">
                    <h3 style="border-bottom:1px solid #334155; padding-bottom:5px; color:#60a5fa;">Purchase Details</h3>
