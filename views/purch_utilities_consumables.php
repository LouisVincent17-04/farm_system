...
<head>
    ...
    <title>Utilities & Consumables Purchase</title>
...
<body>
    <div class="container">
        <div class="header">
            <div class="header-info">
                ...
                <p>Manage and track utility and consumable purchases</p>
            </div>
            ...
            <table class="table">
                ...
                <tbody id="item-table">
                    ...
                    <tr data-item-id="<?php echo $item['ITEM_ID']; ?>"
                        ...
                        <td>
                            <div class="item-id">UTL-<?php echo str_pad($item['ITEM_ID'], 4, '0', STR_PAD_LEFT); ?></div>
                        </td>
                        <td>
    ...
    <div id="modal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 id="modal-title">Add Utility/Consumable Purchase</h2>
            </div>
                ...
                <form id="item-form" method="POST">
                    ...
                    <div class="info-group">
                        ...
                        <div class="form-group autocomplete-wrapper">
                            ...
                            <input type="text" id="item-name" name="item_name" placeholder="e.g., Diesel, Light Bulb, Soap" required maxlength="300" autocomplete="off">
    ...
    <div id="confirm-all-modal" class="modal">
        <div class="modal-content" style="max-width: 450px;">
            <div class="modal-body confirm-content">
                ...
                <p style="color: #64748b;">This will confirm and lock <strong>ALL</strong> currently pending utility/consumable purchases.</p>
                <div class="warning-text">
    ...
    <form id="deleteItemForm" method="POST" action="../process/deleteUtilityPurchase.php" style="display: none;">
    ...
    <script>
        ...
        function fetchAutocomplete(searchTerm) {
            fetch(`../process/searchUtilities.php?term=${encodeURIComponent(searchTerm)}`)
                .then(response => response.json())
        ...
        function openAddModal() {
            document.getElementById('modal-title').textContent = 'Add Utility/Consumable Purchase';
        ...
        function populateEditForm(data) {
            document.getElementById('modal-title').textContent = 'Edit Utility/Consumable Purchase';
