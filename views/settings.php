...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Settings Grid */
        .settings-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap: 2rem; margin-bottom: 2rem; justify-content: center; }
        ...
        .card-icon.weaning { background: linear-gradient(135deg, #f59e0b, #d97706); } /* Orange for Weaning */
        ...
        .card-action { display: flex; align-items: center; justify-content: center; gap: 0.75rem; background: linear-gradient(135deg, #22c55e, #16a34a); color: white; padding: 1rem 2rem; border-radius: 12px; font-weight: 600; font-size: 1rem; border: none; cursor: pointer; transition: all 0.3s ease; width: 100%; margin-top: auto; }
        .card-action:hover { transform: translateY(-2px); box-shadow: 0 10px 30px rgba(34, 197, 94, 0.3); background: linear-gradient(135deg, #16a34a, #15803d); }
    ...
    <div class="settings-container">
        ...
        <div class="settings-grid">
            ...
            <div class="settings-card">
                ...
                <button class="card-action" style="background: linear-gradient(135deg, #f59e0b, #d97706);" onclick="window.location.href='auto_weaning.php'">
