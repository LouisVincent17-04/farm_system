...
try {
    ...
    // --- 1. KPI: ASSET METRICS ---
    // Counts items under 'Others' (ITEM_TYPE_ID = 12)
    $kpi_sql = "SELECT 
                    COUNT(*) as distinct_items,
                    COALESCE(SUM(TOTAL_COST), 0) as total_value,
                    COALESCE(SUM(QUANTITY), 0) as total_units
                FROM items 
                WHERE ITEM_TYPE_ID = 12 AND STATUS = 1";
    ...
    // High-value miscellaneous items
    ...
    // Spending on other supplies over the last 12 months
    $trend_sql = "SELECT 
    ...
    // Most abundant general supplies
    ...
    error_log("Others Analytics Error: " . $e->getMessage());
}
?>
...
<head>
    ...
    <style>
        ...
        .title { 
            ...
            background: linear-gradient(135deg, #a1a1aa, #52525b); /* Zinc Gradient */
        ...
        .kpi-label { color: #a1a1aa; font-size: 0.8rem; font-weight: 600; text-transform: uppercase; letter-spacing: 1px; }
        ...
        .btn { 
            padding: 10px 20px; background: rgba(161, 161, 170, 0.1); 
            color: #d4d4d8; border: 1px solid rgba(161, 161, 170, 0.3); 
            border-radius: 8px; text-decoration: none; font-weight: 600; 
            transition: all 0.2s; 
        }
        .btn:hover { background: rgba(161, 161, 170, 0.2); transform: translateY(-2px); }
...
<div class="container">
    ...
    <div class="kpi-grid">
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-value text-zinc"><?= number_format($kpi['distinct_items']) ?></div>
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-value text-gray">₱<?= number_format($avg_cost, 2) ?></div>
    ...
    <div class="charts-container">
        ...
        <div class="chart-box">
            <div class="chart-title">💰 Value Distribution by Item</div>
            <div style="flex-grow: 1; position: relative;">
        ...
        <div class="chart-box" style="grid-column: 1 / -1;">
            <div class="chart-title">📊 Top 5 General Items by Quantity</div>
    ...
    new Chart(document.getElementById('distChart'), {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: ['#52525b', '#71717a', '#a1a1aa', '#d4d4d8', '#e4e4e7'], // Zinc shades
                borderWidth: 0
            }]
        },
        options: {
    ...
    new Chart(document.getElementById('qtyChart'), {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: 'rgba(161, 161, 170, 0.7)', // Light Zinc
                borderColor: '#71717a',
                borderWidth: 1,
                borderRadius: 4
            }]
