...
try {
    ...
    // --- 2. BUILD SQL QUERY ---
    // Fetch items where ITEM_TYPE_ID = 10 (Vitamins & Supplements)
    $sql = "SELECT 
            i.ITEM_ID,
            i.ITEM_NAME,
            i.ITEM_DESCRIPTION,
...
<head>
    ...
    <title>Vitamins & Supplements Report</title>
    ...
    <style>
        ...
        .title { 
            ...
            background: linear-gradient(135deg, #84cc16, #65a30d); /* Lime Green */
        ...
        .form-input:focus { border-color: #84cc16; outline: none; }
        ...
        th { 
            background: rgba(15, 23, 42, 0.9); color: #a3e635; 
...
<div class="container">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-val text-lime"><?= number_format($total_units) ?></div>
        </div>
        <div class="stat-card">
        ...
        <form method="GET">
            <div class="filter-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="search" class="form-input" placeholder="e.g. Multivitamins, Iron" value="<?= htmlspecialchars($search_term) ?>">
                </div>
    ...
    <div class="table-wrap">
        <table>
            ...
            <tbody>
                <?php if(empty($items)): ?>
                    <tr><td colspan="7" style="text-align:center; padding:3rem; color:#64748b;">No vitamins records found.</td></tr>
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; font-weight:bold; color:#a3e635;">
...
<script>
    ...
    function exportPDF() {
        ...
        doc.text("Vitamins & Supplements Report", 14, 15);
    ...
    function exportExcel() {
        ...
        XLSX.writeFile(wb, "Vitamins_Report_" + new Date().toISOString().slice(0,10) + ".xlsx");
    }
    ...
    function exportCSV() {
        ...
        link.setAttribute("download", "Vitamins_Report_" + new Date().toISOString().slice(0,10) + ".csv");
