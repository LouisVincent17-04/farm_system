...
try {
    ...
    // MySQL: Use DATE_FORMAT instead of TO_CHAR
...
<head>
    ...
    <style>
        ...
        /* Filter Tabs */
        .filter-tabs { display: flex; gap: 1rem; margin-bottom: 1.5rem; border-bottom: 1px solid #334155; padding-bottom: 0.5rem; }
        ...
        .account-avatar { width: 2.5rem; height: 2.5rem; background: linear-gradient(135deg, #3b82f6, #9333ea); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: bold; color: white; }
        ...
        /* Farm Employee (Green/Nature Theme) */
        .role-badge.farm_employee { 
        ...
        .action-btn { padding: 6px; border-radius: 6px; border: none; cursor: pointer; background: transparent; transition: all 0.2s; }
        ...
        .role-option:hover { background: rgba(55, 65, 81, 0.5); }
        ...
        .modal-content { background: #1e293b; border-radius: 0.75rem; width: 100%; max-width: 28rem; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25); border: 1px solid #475569; }
                ...
                <tbody id="account-table">
                    ...
                    <?php else: ?>
                        ...
                        <tr data-user-id="<?php echo $user['USER_ID']; ?>" 
                            ...
                            <td style="color: #94a3b8;"><?php echo htmlspecialchars($user['EMAIL']); ?></td>
                            ...
                            <td style="color: #64748b; font-size: 0.9rem;"><?php echo $user['JOIN_DATE']; ?></td>
                            <td>
