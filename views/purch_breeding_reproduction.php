...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .category-consumable { background: var(--orange-dim); color: var(--orange); border: 1px solid rgba(249,115,22,0.2); }
        ...
        .form-control:focus, .form-select:focus, textarea.form-control:focus { border-color: var(--orange); box-shadow: 0 0 0 3px var(--orange-glow); background: var(--bg-hover); }
        ...
        .info-group h3 { font-size: 0.9rem; text-transform: uppercase; letter-spacing: 0.05em; color: var(--orange); margin: 1.5rem 0 1rem 0; border-bottom: 1px solid var(--border); padding-bottom: 8px; }
...
<div class="container">
    ...
    <div class="top-bar">
        ...
        <span class="page-badge"><i class="fa-solid fa-mars-and-venus"></i> Biological Inventory</span>
    </div>
            ...
            <form id="item-form" method="POST">
                ...
                <div class="info-group" style="margin-top: 0;">
                    ...
                    <div class="form-group autocomplete-wrapper">
                        ...
                        <input type="text" id="item-name" name="item_name" class="form-control" placeholder="e.g., Breeding Kit" required maxlength="300" autocomplete="off">
                    ...
                    <div class="form-row">
                        <div class="form-group autocomplete-wrapper">
                            ...
                            <input type="text" id="supplier" name="supplier" class="form-control" placeholder="e.g., ABC Farm Supplies" autocomplete="off">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="net-weight" name="item_net_weight" class="form-control val-mono" placeholder="e.g., 500" step="0.01" min="0">
                        </div>
                    </div>
...
<div id="confirm-modal" class="modal">
    <div class="modal-content" style="max-width: 450px;">
        <div class="modal-body confirm-content">
            ...
            <p style="color: var(--text-secondary); margin-bottom: 5px;">You are confirming the intake of <strong><span id="confirm-item-qty"></span> <span id="confirm-item-name" style="color:var(--orange);"></span></strong>.</p>
...
<div id="confirm-all-modal" class="modal">
    <div class="modal-content" style="max-width: 450px;">
        <div class="modal-body confirm-content">
            ...
            <p style="color: var(--text-secondary);">This function will verify and lock <strong>ALL</strong> currently pending breeding &amp; reproduction purchases in this location.</p>
...
<script>
        ...
        const html = `
            ...
            <div class="info-group" style="margin-top:20px;">
                ...
                <div style="display:grid; grid-template-columns: 1fr 1fr; gap:10px;">
                    ...
                    <p style="color:var(--text-secondary); margin:0;"><strong>Net Wt/Content:</strong> <br><span class="val-mono">${data.netWeight || '0'}</span></p>
                </div>
    ...
    function saveItem() {
        ...
        const url = isEdit ? '../process/editBreedingReproductionSupplies.php' : '../process/addBreedingReproductionSupplies.php';
