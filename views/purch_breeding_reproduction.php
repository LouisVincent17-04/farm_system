...
<head>
    ...
    <title>Breeding & Reproduction Supplies Management</title>
    <link rel="stylesheet" href="../css/purch_breeding_reproduction.css">
    <style>
        ...
        .status-badge.confirmed { background: rgba(16, 185, 129, 0.1); color: #059669; border: 1px solid rgba(16, 185, 129, 0.2); }
...
<body>
    <div class="container">
        <div class="header">
            <div class="header-info">
                <h1>Breeding & Reproduction Supplies</h1>
                <p>Manage and track Breeding & Reproduction Supplies purchases</p>
            </div>
        ...
        <div class="table-container">
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th>Quantity</th>
                        <th>Unit</th>
                        <th>Net Weight / Content Amount</th>
                        <th>Unit Cost</th>
                        <th>Total Cost</th>
                        <th>Category</th>
                        <th>Purchase Date</th>
                ...
                <tbody id="item-table">
                    ...
                    <tr data-item-id="<?php echo $item['ITEM_ID']; ?>"
                        ...
                        <td>
                            <div class="item-id">BRE-<?php echo str_pad($item['ITEM_ID'], 4, '0', STR_PAD_LEFT); ?></div>
                        </td>
                        ...
                        <td>
                            <div class="amount">₱<?php echo number_format($totalCost, 2); ?></div>
                        </td>
                        <td>
            ...
            <div id="empty-state" class="empty-state">
                <h3>No Breeding & Reproduction Supplies found</h3>
    ...
    <div id="modal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 id="modal-title">Add Breeding & Reproduction Supplies Purchase</h2>
            </div>
                ...
                <form id="item-form" method="POST">
                    ...
                    <div class="info-group">
                        ...
                        <div class="form-group autocomplete-wrapper">
                            ...
                            <input type="text" id="item-name" name="item_name" placeholder="e.g., Breeding Kit" required maxlength="300" autocomplete="off">
                            <div id="autocomplete-list" class="autocomplete-list"></div>
                        </div>

                        <div class="form-row">
                            <div class="form-group">
                                <label for="net-weight">Net Weight / Content Amount</label>
    ...
    <div id="confirm-all-modal" class="modal">
        <div class="modal-content" style="max-width: 450px;">
            <div class="modal-body confirm-content">
                ...
                <p style="color: #64748b;">This will confirm and lock <strong>ALL</strong> currently pending supplies purchases.</p>
                <div class="warning-text">
    ...
    <script>
        ...
        function submitConfirmation() {
            ...
            fetch('../purchase_confirmations/confirmBreedingReproductionSupplies.php', {
                method: 'POST',
                body: formData
            })
        ...
        function submitConfirmAll() {
            ...
            fetch('../purchase_confirmations/confirmAllBreedingReproductionSupplies.php', {
                method: 'POST'
            })
            .then(response => response.json())
            .then(data => {
        ...
        function openAddModal() {
            document.getElementById('modal-title').textContent = 'Add Breeding & Reproduction Supplies Purchase';
        ...
        function populateEditForm(data) {
            document.getElementById('modal-title').textContent = 'Edit Breeding & Reproduction Supplies Purchase';
