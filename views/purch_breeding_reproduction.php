                    ...
                    <div class="info-group" style="margin-top: 0;">
                        ...
                        <div class="form-row">
                            <div class="form-group autocomplete-wrapper">
                                ...
                                <input type="text" id="supplier" name="supplier" placeholder="e.g., ABC Farm Supplies" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label for="net-weight">Net Wt / Content Amount</label>
    ...
    <div id="confirm-all-modal" class="modal">
        <div class="modal-content" style="max-width: 450px;">
            <div class="modal-body confirm-content">
                ...
                <p style="color: #94a3b8;">This will confirm and lock <strong>ALL</strong> currently pending breeding & reproduction supplies purchases.</p>
                <div class="warning-text">
        ...
        function viewItem(button) {
            ...
            const html = `
                ...
                <div class="info-group" style="margin-top:20px;">
                    ...
                    <p><strong>Net Wt/Content:</strong> ${data.net_weight || 'N/A'}</p>
