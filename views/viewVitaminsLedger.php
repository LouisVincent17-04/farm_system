...
<head>
    ...
    <title>Vitamin Ledger | <?= htmlspecialchars($vitamin['SUPPLY_NAME'] ?? 'Details') ?></title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        body {
            ...
            background-image: radial-gradient(ellipse 80% 50% at 50% -20%, rgba(163,230,53,0.05) 0%, transparent 60%);
        }
        ...
        .supply-title span.text-lime { background: linear-gradient(135deg, var(--lime), #65a30d); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
        ...
        .stat-lime::before { background: var(--lime); }
        ...
        .type-usage { background: var(--lime-dim); color: var(--lime); border: 1px solid rgba(163,230,53,0.3); } /* Lime for Vitamin Usage */
...
<div class="container">
    ...
    <?php if(isset($error)): ?>
        <div class="error-box">
            ...
            <p style="color: var(--text-muted); margin-top: 0.5rem;">The requested supplement profile could not be loaded.</p>
        </div>
    <?php else: ?>

        <div class="supply-header-wrapper">
            <h1 class="supply-title">
                <span class="text-lime"><?= htmlspecialchars($vitamin['SUPPLY_NAME']) ?></span>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card stat-emerald" style="background: rgba(16,185,129,0.05);">
                ...
                <div class="stat-val c-stock"><?= number_format($vitamin['TOTAL_STOCK'], 2) ?> <span><?= htmlspecialchars($unit_label) ?></span></div>
            </div>
        </div>
                        ...
                        <?php if(empty($ledger)): ?>
                            <tr>
                                <td colspan="4" class="empty-state">
                                    ...
                                    No transaction history found for this supplement.
                                </td>
                            </tr>
                        <?php else: ?>
                            <?php foreach($ledger as $row): 
                                ...
                                if ($row['txn_type'] == 'Supplement Administered') { $badgeClass = 'type-usage'; $icon = 'fa-flask'; }
