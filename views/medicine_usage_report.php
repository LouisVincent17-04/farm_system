...
<head>
    ...
    <title>Medicine Usage & Accountancy | FarmPro</title>
    ...
    <style>
        ...
        :root {
            ...
            --border-active:  rgba(225,29,72,0.5); /* Rose/Red Accent */
            --rose:           #e11d48;
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .c-stock::before    { background: var(--rose); }
        ...
        .c-stock .acc-icon { background: var(--rose-dim); color: var(--rose); }
        ...
        .c-stock .acc-val { color: var(--rose); }
        ...
        .filter-badge {
            ...
            background: var(--rose); color: #000; border-radius: 99px; padding: 0 6px;
        }
        .filter-toggle-btn {
        ...
        .form-control:focus, .form-select:focus { border-color: var(--rose); box-shadow: 0 0 0 3px var(--rose-glow); background: var(--bg-hover); }
        ...
        .btn-primary:hover { background: #be123c; box-shadow: 0 0 16px var(--rose-glow); }
        ...
        @media (max-width: 768px) {
            ...
            .row-total { background: var(--rose-dim); border-color: rgba(225,29,72,0.3); }
        }
    </style>
</head>
<body>
...
<div class="container">
    ...
    <div class="page-header">
        <div class="header-info">
            <h1 class="page-title">Medicine Usage <span>&amp; Ledger</span></h1>
            <p class="page-subtitle">Financial and physical overview of medicine purchases, usage, adjustments, and live balances.</p>
        </div>
    </div>
    ...
    <div class="filter-panel">
        ...
        <div class="filter-footer">
            <div class="filter-footer-left">
                <a href="medicine_usage_report.php" class="btn btn-ghost btn-sm">
    ...
    <?php if(empty($grouped_data) && $purchased_qty == 0 && empty($adjustments_data)): ?>
        <div class="empty-state">
            ...
            <h3>No Medicine Activity Found</h3>
    ...
    <?php else: ?>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php foreach ($group['items'] as $item): ?>
                                <tr>
                                    <td data-label="Medicine Name" class="col-name"><?= htmlspecialchars($item['ITEM_NAME']) ?></td>
                                    <td data-label="Purchased (IN)" class="t-right val-mono text-green">
                                        <?= number_format($item['PURCHASED_QTY'], 2) ?> units
                                    </td>
                                    <td data-label="Units Used (OUT)" class="t-right val-mono" style="color:var(--rose);">
                        ...
                        <tbody>
                            <?php foreach ($adjustments_data as $adj): ?>
                                <tr>
                                    ...
                                    <td data-label="Medicine Name" class="col-name"><?= htmlspecialchars($adj['ITEM_NAME']) ?></td>
                                    <td data-label="Type">
                        ...
                        <tbody>
                            <?php foreach ($purchases_by_item as $fName => $pData): ?>
                                ...
                                <tr>
                                    ...
                                    <td data-label="Medicine Name" class="col-name"><?= htmlspecialchars($pData['original_name']) ?></td>
                                    <td data-label="Purchased (IN)" class="t-right val-mono text-green">
        ...
        <div class="group-container" style="border-color: var(--rose);">
            <div class="group-header" style="background: rgba(225, 29, 72, 0.15); color: #fff;">
                <i class="fa-solid fa-chart-pie"></i> GRAND TOTAL (Filtered Outwards)
            </div>
            <div class="table-wrap">
                <table class="table">
                    <tbody>
                        <tr class="row-total" style="font-size: 1rem; background: rgba(225, 29, 72, 0.1);">
                            <td data-label="Summary" style="color: var(--rose);">OVERALL ADMINISTERED</td>
                            <td data-label="Units Used (OUT)" class="t-right val-mono" style="color: var(--rose);"><?= number_format($grand_total_used, 2) ?> units</td>
