    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .title { 
            ...
            font-weight: 800; 
            background: linear-gradient(135deg, #e11d48, #be123c); /* Rose/Crimson */
...
<div class="container">
    ...
    <div class="header">
        <h1 class="title">Breeding & Reproduction Report</h1>
        <p class="subtitle">Log of breeding supplies, hormones, and reproductive tools.</p>
    </div>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-val text-rose"><?= number_format($total_units) ?></div>
        </div>
        <div class="stat-card">
            <div class="stat-lbl">Total Purchase Value</div>
            <div class="stat-val text-crimson">₱<?= number_format($total_value, 2) ?></div>
        </div>
    </div>
        ...
        <form method="GET">
            <div class="filter-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="search" class="form-input" placeholder="e.g. Catheter, Hormones" value="<?= htmlspecialchars($search_term) ?>">
                </div>
                
                <div class="btn-group">
                    <button type="submit" class="btn btn-primary">Apply Filters</button>
                    <a href="breeding_report.php" class="btn btn-outline">Reset</a>
                </div>
            </div>
    ...
    <div class="table-wrap">
        <table>
            ...
            <tbody>
                <?php if(empty($items)): ?>
                    <tr><td colspan="7" style="text-align:center; padding:3rem; color:#64748b;">No breeding supply records found.</td></tr>
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td data-label="Quantity" style="text-align:right; font-weight:bold; color:#fb7185;">
                            <?= number_format($i['QUANTITY']) ?>
                        </td>
                        <td data-label="Unit Cost" style="text-align:right;">₱<?= number_format($i['UNIT_COST'], 2) ?></td>
                        <td data-label="Total Cost" style="text-align:right; color:#f43f5e;">₱<?= number_format($i['CALCULATED_TOTAL'], 2) ?></td>
                    </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
...
<script>
    ...
    function exportPDF() {
        ...
        doc.text("Breeding Supplies Purchase Report", 14, 15);
