...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .action-btn.view:hover { color: var(--amber); border-color: var(--amber); }
                    ...
                    <div class="form-stack">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" id="net-weight" name="item_net_weight" class="form-control" placeholder="e.g., 50.5" step="0.01" min="0">
                            </div>
                            <div class="form-group">
