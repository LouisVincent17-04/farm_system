...
<head>
    ...
    <title>Housing & Facilities Management</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            <div class="header-info">
                <h1>Housing & Facilities</h1>
                <p>Manage and track housing and facilities purchases</p>
            </div>
    ...
    <div id="modal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 id="modal-title">Add Housing/Facilities Purchase</h2>
            </div>
                ...
                <form id="item-form" method="POST">
                    ...
                    <div class="info-group" style="margin-top: 0;">
                        ...
                        <div class="form-group autocomplete-wrapper">
                            ...
                            <input type="text" id="item-name" name="item_name" placeholder="e.g., Dog Kennel 6x4 feet" required maxlength="300" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group autocomplete-wrapper">
                                ...
                                <input type="text" id="supplier" name="supplier" placeholder="e.g., Build Right Inc." autocomplete="off">
    ...
    <div id="confirm-all-modal" class="modal">
        <div class="modal-content" style="max-width: 450px;">
            <div class="modal-body confirm-content">
                ...
                <p style="color: #94a3b8;">This will confirm and lock <strong>ALL</strong> currently pending housing/facilities purchases.</p>
                <div class="warning-text">
    ...
    <script>
        ...
        function openAddModal() {
            document.getElementById('modal-title').textContent = 'Add Housing/Facilities Purchase';
        ...
        function viewItem(button) {
            ...
            const data = {
                ...
                supplier: row.dataset.supplier, reference_no: row.dataset.referenceNo, created_at: row.dataset.createdAt
            };
        ...
        function editItem(button) {
            ...
            document.getElementById('modal-title').textContent = 'Edit Housing/Facilities Purchase';
            ...
            if(data.buildingId) {
                bldgSelect.value = data.buildingId;
                filterPens();
