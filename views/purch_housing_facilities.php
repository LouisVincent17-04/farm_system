<?php
// views/purch_housing_facilities.php
error_reporting(0);
...
<head>
    ...
    <title>Housing & Facilities Management | FarmPro</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-primary:hover { background: #c084fc; box-shadow: 0 0 16px var(--purple-glow); transform: translateY(-1px); }
        ...
        .form-control:focus, .form-select:focus, textarea.form-control:focus { border-color: var(--purple); box-shadow: 0 0 0 3px var(--purple-glow); background: var(--bg-hover); }
        ...
        .info-group h3 { font-size: 0.9rem; text-transform: uppercase; letter-spacing: 0.05em; color: var(--purple); margin: 1.5rem 0 1rem 0; border-bottom: 1px solid var(--border); padding-bottom: 8px; }
        ...
        .autocomplete-item:hover { background: var(--bg-hover); color: var(--purple); }
        .autocomplete-item strong { color: var(--purple); }
...
<div class="container">
    ...
    <div class="top-bar">
        ...
        <span class="page-badge"><i class="fa-solid fa-house-chimney-window"></i> Capital Expenditure</span>
    </div>

    <div class="page-header">
        <div class="header-info">
            <h1>Housing <span>&amp; Facilities</span></h1>
            <p>Log and manage infrastructure, pens, and shelter acquisitions.</p>
        </div>
    ...
    <div class="search-container">
        ...
        <input type="text" class="search-input" id="searchInput" placeholder="Quick search by facility name, supplier, or reference no..." onkeyup="filterTable()">
    </div>
                        ...
                        <tr>
                            <td colspan="12">
                                <div class="empty-state">
                                    ...
                                    No facility purchases recorded yet in this location.
                                </div>
                            </td>
                        </tr>
                    <?php else: ?>
...
<div id="modal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            <h2 id="modal-title">Add Facilities Purchase</h2>
        </div>
            ...
            <form id="item-form" method="POST">
                ...
                <div class="info-group" style="margin-top: 0;">
                    ...
                    <div class="form-group autocomplete-wrapper">
                        <label class="form-label" for="item-name">Facility Name <span>*</span></label>
                        <input type="text" id="item-name" name="item_name" class="form-control" placeholder="e.g., Metal Farrowing Crate" required maxlength="300" autocomplete="off">
                    ...
                    <div class="form-row">
                        <div class="form-group autocomplete-wrapper">
                            ...
                            <input type="text" id="supplier" name="supplier" class="form-control" placeholder="e.g., AgriBuild Inc." autocomplete="off">
...
<div id="confirm-modal" class="modal">
    <div class="modal-content" style="max-width: 450px;">
        <div class="modal-body confirm-content">
            <span class="confirm-icon" style="color:var(--purple);">🏠</span>
            <h2 style="color: #fff; margin-bottom: 10px;">Verify Acquisition?</h2>
            <p style="color: var(--text-secondary); margin-bottom: 5px;">You are confirming the intake of <strong><span id="confirm-item-qty"></span> <span id="confirm-item-name" style="color:var(--purple);"></span></strong>.</p>
...
<div id="confirm-all-modal" class="modal">
    <div class="modal-content" style="max-width: 450px;">
        <div class="modal-body confirm-content">
            ...
            <p style="color: var(--text-secondary);">This function will verify and lock <strong>ALL</strong> currently pending facility purchases in this location.</p>
...
<form id="deleteItemForm" method="POST" action="../process/deleteHousingAndFacilities.php" style="display: none;">
...
<script>
    ...
    function submitConfirmation() {
        ...
        fetch('../purchase_confirmations/confirmHousingAndFacilities.php', { method: 'POST', body: formData })
            .then(r => r.json())
            .then(data => {
    ...
    function submitConfirmAll() {
        ...
        fetch('../purchase_confirmations/confirmAllHousingAndFacilities.php', { method: 'POST' })
            .then(r => r.json())
            .then(data => {
                if (data.success) { showToast(data.message, 'success'); setTimeout(() => window.location.reload(), 1000); } 
    ...
    function fetchAutocomplete(searchTerm) {
        fetch(`../process/searchHousingAndFacilities.php?term=${encodeURIComponent(searchTerm)}`)
    ...
    function openAddModal() {
        document.getElementById('modal-title').textContent = 'Add Facilities Purchase';
        document.getElementById('btn-save').innerHTML = '<i class="fa-solid fa-floppy-disk me-2"></i> Save Purchase';
        document.getElementById('item-form').reset();
        document.getElementById('item-id').value = '';
        document.getElementById('item-category').value = '0'; // Default Non-Consumable for Housing
    ...
    function editItem(button) {
        ...
        document.getElementById('modal-title').textContent = 'Edit Facilities Purchase';
    ...
    function saveItem() {
        ...
        const url = isEdit ? '../process/editHousingAndFacilities.php' : '../process/addHousingAndFacilities.php';
