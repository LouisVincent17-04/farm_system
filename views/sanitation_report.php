...
<div class="container">
    <div class="header">
        <h1 class="title">Sanitation & Waste Report</h1>
        <p class="subtitle">Log of sanitation supplies and waste management acquisitions.</p>
    </div>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-val text-teal"><?= number_format($total_units) ?></div>
        </div>
        <div class="stat-card">
            <div class="stat-lbl">Total Purchase Value</div>
            <div class="stat-val text-emerald">₱<?= number_format($total_value, 2) ?></div>
        </div>
    </div>
        ...
        <form method="GET">
            <div class="filter-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="search" class="form-input" placeholder="e.g. Disinfectant, Bags" value="<?= htmlspecialchars($search_term) ?>">
                </div>
                
                <div class="btn-group">
                    <button type="submit" class="btn btn-primary">Apply Filters</button>
                    <a href="sanitation_report.php" class="btn btn-outline">Reset</a>
                </div>
            </div>
    ...
    <div class="table-wrap">
        <table>
            ...
            <tbody>
                <?php if(empty($items)): ?>
                    <tr><td colspan="7" style="text-align:center; padding:3rem; color:#64748b;">No sanitation records found.</td></tr>
                <?php else: ?>
...
<script>
    ...
    function exportPDF() {
        ...
        doc.text("Sanitation & Waste Purchase Report", 14, 15);
