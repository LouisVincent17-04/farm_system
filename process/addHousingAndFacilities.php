<?php
// addHousingAndFacilities.php - Handles adding new Housing & Facilities items    
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if ($stmt->execute($params)) {
            ...
            // 7. INSERT AUDIT LOG
            $logDetails = "Added new Housing Item: $item_name (Supplier: $supplier, Qty: $item_quantity, Cost: $total_cost). New ID: $new_item_id";
