...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['item_id'])) {
    ...
    try {
        ...
        // 3. INSERT AUDIT LOG
        $logDetails = "Permanently deleted Item: $item_name (Type: $item_type_name, ID: $item_id)";
        
        // Note: Adjusted column names slightly to match standard Audit Log structure if needed. 
        // If your table has a RECORD_ID column, keep it; otherwise, usually ID is put in ACTION_DETAILS.
        // Assuming your MySQL AUDIT_LOGS schema supports RECORD_ID based on your provided code.
        $log_sql = "INSERT INTO AUDIT_LOGS 
                    (USER_ID, USERNAME, ACTION_TYPE, TABLE_NAME, RECORD_ID, ACTION_DETAILS, IP_ADDRESS) 
                    VALUES 
                    (:user_id, :username, 'DELETE_ITEM', 'ITEMS', :record_id, :details, :ip)";
        ...
        if ($e->errorInfo[1] == 1451) {
             $error_msg = "Cannot delete item '$item_name'. It is currently linked to other records (e.g., purchase or usage history).";
        }
