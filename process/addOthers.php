<?php
// addOthers.php - Handles adding new "Other" items to the inventory
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if ($stmt->execute($params)) {
            ...
            // 7. INSERT AUDIT LOG
            $logDetails = "Added new Item (Others): $item_name (Supplier: $supplier, Qty: $item_quantity, Cost: $total_cost). New ID: $new_item_id";
