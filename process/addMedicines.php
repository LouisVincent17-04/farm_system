...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if ($stmt->execute($params)) {
            ...
            // 7. INSERT AUDIT LOG
            $logDetails = "Added new Medicine: $item_name (Qty: $item_quantity, Cost: $total_cost). New ID: $new_item_id";
            ...
            echo json_encode([
                'success' => true, 
                'message' => '✅ Medicine purchase recorded successfully (ID: ' . $new_item_id . ')'
            ]);
