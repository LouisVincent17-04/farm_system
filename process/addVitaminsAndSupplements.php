<?php
// process/addVitaminsAndSupplements.php
session_start(); // 1. Start Session
error_reporting(0);
ini_set('display_errors', 0);

include '../config/Connection.php'; // Ensure correct path to Connection.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $item_type_id = 10; // ID for Vitamins & Supplements
        ...
        if ($stmt->execute($params)) {
            ...
            // 7. INSERT AUDIT LOG
            $logDetails = "Added new Vitamin/Supplement Purchase: $item_name (Qty: $item_quantity, Cost: $total_cost). New ID: $new_item_id";
            
            $log_sql = "INSERT INTO AUDIT_LOGS 
                        (USER_ID, USERNAME, ACTION_TYPE, TABLE_NAME, ACTION_DETAILS, IP_ADDRESS) 
                        VALUES 
                        (:user_id, :username, 'ADD_PURCHASE', 'ITEMS', :details, :ip)";
