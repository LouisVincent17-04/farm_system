...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['item_id'])) {
    ...
    try {
        ...
        $original_sql = "SELECT ITEM_NAME, QUANTITY, ITEM_NET_WEIGHT, TOTAL_COST, EXPIRATION_DATE, SUPPLIER FROM ITEMS WHERE ITEM_ID = :item_id";
        ...
        // 5. INSERT AUDIT LOG
        $logDetails = "Updated Medicine Purchase (ID: $item_id). Name: $original_name -> $item_name. Qty: $original_qty -> $item_quantity. Expiry: $original_expiry -> " . ($expiration_date ?? 'N/A');
        ...
        echo json_encode([
            'success' => true, 
            'message' => '✅ Medicine purchase updated successfully'
        ]);
