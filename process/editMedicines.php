...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['item_id'])) {
    ...
    try {
        ...
        // UPDATED: Include EXPIRATION_DATE in select
        ...
        // 5. INSERT AUDIT LOG
        $logDetails = "Updated Medicine Purchase (ID: $item_id). Name: $original_name -> $item_name. Qty: $original_qty -> $item_quantity. Cost: $original_cost -> $total_cost. Expiry: $original_expiry -> " . ($expiration_date ?? 'N/A');
