<?php
// process/editAdministrationAndRecords.php
session_start();
error_reporting(0);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['item_id'])) {
    ...
    try {
        ...
        // Capture Supplier and Reference No
        ...
        // 5. INSERT AUDIT LOG
        $logDetails = "Updated Admin/Records Purchase (ID: $item_id). Name: $original_name -> $item_name. Qty: $original_qty -> $item_quantity. Cost: $original_cost -> $total_cost.";
