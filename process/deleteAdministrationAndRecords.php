...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['item_id'])) {
    ...
    try {
        ...
        // 1. FETCH ITEM NAME FIRST (For the Audit Log)
        ...
        if (!$item_row) {
            // Rollback is technically not needed here as we haven't written anything yet, 
        ...
        // 3. INSERT AUDIT LOG
        $logDetails = "Deleted Item: $item_name (ID: $item_id)";
        ...
        // This happens if other tables reference this ITEM_ID as a foreign key
