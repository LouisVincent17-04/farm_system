<?php
// editFarmEquipmentAndTools.php - Handles editing existing farm equipment and tools purchases in the inventory system.
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['item_id'])) {
    ...
    try {
        ...
        $original_sql = "SELECT ITEM_NAME, QUANTITY, TOTAL_COST, SUPPLIER FROM ITEMS WHERE ITEM_ID = :item_id";
        ...
        // 5. INSERT AUDIT LOG
        $logDetails = "Updated Farm Equipment Purchase (ID: $item_id). Name: $original_name -> $item_name. Qty: $original_qty -> $item_quantity. Cost: $original_cost -> $total_cost.";
