...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['item_id'])) {
    ...
    try {
        ...
        $date_of_purchase = $_POST['date_of_purchase']; // MySQL handles 'YYYY-MM-DD' directly
        ...
        $original_sql = "SELECT ITEM_NAME, QUANTITY, TOTAL_COST FROM ITEMS WHERE ITEM_ID = :item_id";
