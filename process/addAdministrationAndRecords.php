<?php
// process/addAdministrationAndRecords.php
session_start();
error_reporting(0);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Capture Supplier and Reference Number
        ...
        if ($stmt->execute($params)) {
            ...
            // 2. INSERT AUDIT LOG
            $logDetails = "Added new Admin Record item: $item_name (Supplier: $supplier, Qty: $item_quantity, Cost: $total_cost)";
