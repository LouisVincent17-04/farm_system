...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if ($stmt->execute($params)) {
            ...
            // 7. INSERT AUDIT LOG
            $logDetails = "Added new Vaccine Purchase: $item_name (Supplier: $supplier, Qty: $item_quantity, Cost: $total_cost). Expiry: " . ($expiration_date ?? 'N/A');
            ...
            echo json_encode([
                'success' => true, 
                'message' => '  Vaccine purchase recorded successfully (ID: ' . $new_item_id . ')'
            ]);
