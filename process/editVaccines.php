...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['item_id'])) {
    ...
    try {
        ...
        // 5. INSERT AUDIT LOG
        $logDetails = "Updated Vaccine Purchase (ID: $item_id). Name: $original_name -> $item_name. Qty: $original_qty -> $item_quantity. Expiry: $original_expiry -> " . ($expiration_date ?? 'N/A');
        ...
        echo json_encode([
            'success' => true, 
            'message' => '✅ Vaccine purchase updated successfully'
        ]);
