<?php
// purchase_confirmations/confirmMedicine.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['item_id'])) {
    ...
    try {
        ...
        // 1. Validate item exists AND fetch Name/Cost for the Log (Locking the item)
        ...
        $total_cost = $item_row['TOTAL_COST'] ?? 0; // Get the cost
        ...
        // 2. MERGE INTO MEDICINES (Inventory Logic)
        ...
        // --- 4. AUDIT LOGGING ---
        $logDetails = "Confirmed Medicine Purchase (ID: $item_id): $item_name. Added Stock: $stock_to_add. Added Value: $total_cost";
        ...
        echo json_encode([
            'success' => true, 
            'message' => '✅ Purchase confirmed. Inventory value updated.'
        ]);
