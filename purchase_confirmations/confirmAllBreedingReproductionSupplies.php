<?php
// purchase_confirmations/confirmAllBreedingReproductionSupplies.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Truncate if too long (typically TEXT in MySQL handles large strings, but good practice)
        if (strlen($item_list) > 3800) {
            $item_list = substr($item_list, 0, 3750) . "... [truncated]";
        }
        
        $logDetails = "Bulk confirmed $count Breeding/Repro items: " . $item_list;
