...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Perform the Upsert (Manually via Loop for precision with Expiry)
        ...
        $insert_inv = $conn->prepare("INSERT INTO MEDICINES (SUPPLY_NAME, TOTAL_STOCK, TOTAL_COST, UNIT_ID, EXPIRATION_DATE, DATE_CREATED, DATE_UPDATED)
        ...
        $logDetails = "Bulk confirmed $count Medicine items (Merged into Inventory with Expiry): " . $item_list;
